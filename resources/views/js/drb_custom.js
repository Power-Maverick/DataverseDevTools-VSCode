...
DRB.Utilities.GenerateGuid = function (braces, upperCase) {
    ...
    if (upperCase === true) {
        randomGuid = randomGuid.toUpperCase();
    }
    return randomGuid;
};
...
DRB.Utilities.RemoveDuplicatesFromArray = function (array) {
    var values = array.filter(function (item, pos) {
...
DRB.Utilities.GetRecordByProperty = function (records, propertyName, propertyValue) {
    if (Array.isArray(records)) {
        for (var count = 0; count < records.length; count++) {
            if (records[count].hasOwnProperty(propertyName) && records[count][propertyName] == propertyValue) {
...
DRB.Xrm.GetDemoDataBatch = function (queries) {
    ...
    var entity_CustomTable = {
        SchemaName: "sample_CustomTable",
        LogicalName: "sample_customtable",
        EntitySetName: "sample_customtables",
        PrimaryIdAttribute: "sample_customtableid",
        PrimaryNameAttribute: "sample_name",
        DisplayName: { UserLocalizedLabel: { Label: "Custom Table" } },
    };
    var entity_CustomTable2 = {
        ...
        DisplayName: { UserLocalizedLabel: { Label: "Custom Table (New)" } },
    };
    ...
    columns_Team.push({
        ...
        IsValidForCreate: true,
        IsValidForUpdate: false,
        DisplayName: { UserLocalizedLabel: { Label: "Team" } },
    });

    var columns_Account = [];
    columns_Account.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.StringAttributeMetadata",
        SchemaName: "Name",
        LogicalName: "name",
        AttributeType: "String",
    ...
    oneToMany_Account.push({
        SchemaName: "account_Team",
        ReferencingEntity: "team",
        ReferencedEntity: "account",
        ReferencingAttribute: "teamid",
        ReferencedAttribute: "accountid",
        ReferencingEntityNavigationPropertyName: "team",
        ReferencedEntityNavigationPropertyName: "account_Team",
    });
    oneToMany_Account.push({
        SchemaName: "Team_account",
        ReferencingEntity: "team",
        ReferencedEntity: "account",
        ReferencingAttribute: "teamid2",
        ReferencedAttribute: "accountid",
        ReferencingEntityNavigationPropertyName: "Team2",
        ReferencedEntityNavigationPropertyName: "Team_account",
    });
    ...
    columns_CustomTable.push({
        ...
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Decimal" } },
    });
    columns_CustomTable.push({
        ...
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Money" } },
    });
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.PicklistAttributeMetadata",
        SchemaName: "sample_Choice",
        LogicalName: "sample_choice",
        IsPrimaryId: false,
        IsPrimaryName: false,
        AttributeType: "Picklist",
        IsValidForRead: true,
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Choice" } },
    });
    columns_CustomTable.push({
        ...
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Version Number" } },
    });
    columns_CustomTable.push({
    ...
    columns_CustomTable.push({
        ...
        SchemaName: "sample_DateAndTime",
        LogicalName: "sample_dateandtime",
        IsPrimaryId: false,
        IsPrimaryName: false,
        ...
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Date And Time" } },
    });
    columns_CustomTable.push({
    ...
    columns_CustomTable.push({
        ...
        SchemaName: "sample_WholeNumber",
        LogicalName: "sample_wholenumber",
        IsPrimaryId: false,
        IsPrimaryName: false,
        ...
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Whole Number" } },
    });
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.MoneyAttributeMetadata",
        SchemaName: "sample_Money_Base",
        ...
        IsValidForCreate: true,
        IsValidForUpdate: false,
        DisplayName: { UserLocalizedLabel: { Label: "Money (Base)" } },
    });
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.StringAttributeMetadata",
    ...
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.StringAttributeMetadata",
        SchemaName: "sample_Name2",
        LogicalName: "sample_name2",
        IsPrimaryId: false,
        IsPrimaryName: false,
        AttributeType: "String",
        IsValidForRead: true,
        ...
        IsValidForUpdate: true,
        MaxLength: 91,
        DisplayName: { UserLocalizedLabel: { Label: "Name 2" } },
    });
    columns_CustomTable.push({
        SchemaName: "sample_customtableId",
        LogicalName: "sample_customtableid",
        IsPrimaryId: true,
        IsPrimaryName: false,
        AttributeType: "Uniqueidentifier",
        IsValidForRead: true,
    ...
    columns_CustomTable.push({
        ...
        SchemaName: "sample_PolyId",
        LogicalName: "sample_polyid",
        IsPrimaryId: false,
        IsPrimaryName: false,
        AttributeType: "Lookup",
        Targets: ["contact", "team"],
        IsValidForRead: true,
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Polymorphic Lookup (Contact, Team)" } },
    });

    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.EntityNameAttributeMetadata",
        SchemaName: "sample_PolyIdType",
        LogicalName: "sample_polyidtype",
        IsPrimaryId: false,
        IsPrimaryName: false,
        AttributeType: "EntityName",
        AttributeOf: "sample_polyid",
        IsValidForRead: true,
        IsValidForCreate: true,
        IsValidForUpdate: true,
    });
    ...
    columns_CustomTable.push({
        ...
        SchemaName: "sample_MultipleLines",
        LogicalName: "sample_multiplelines",
        IsPrimaryId: false,
        IsPrimaryName: false,
        AttributeType: "Memo",
        IsValidForRead: true,
        ...
        IsValidForUpdate: true,
        MaxLength: 500,
        DisplayName: { UserLocalizedLabel: { Label: "Multiple Lines" } },
    });
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.LookupAttributeMetadata",
        SchemaName: "sample_ContactId",
        ...
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Lookup (Contact)" } },
    });
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.LookupAttributeMetadata",
        ...
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Customer Lookup" } },
    });
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.DoubleAttributeMetadata",
        SchemaName: "sample_Float",
        LogicalName: "sample_float",
        IsPrimaryId: false,
        IsPrimaryName: false,
        ...
        MaxValue: 10,
        Precision: 3,
        DisplayName: { UserLocalizedLabel: { Label: "Float" } },
    });
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.ImageAttributeMetadata",
        SchemaName: "sample_Image",
        LogicalName: "sample_image",
        IsPrimaryId: false,
        IsPrimaryName: false,
    ...
    var sample_Boolean = {
        ...
        EntityLogicalName: "sample_customtable",
        LogicalName: "sample_boolean",
        AttributeType: "Boolean",
        OptionSet: sample_Boolean_Values,
    };
    var columns_values_CustomTable = [sample_Boolean];

    var sample_Choices_Values = {
        OptionSetType: "MultiPicklist",
        Options: [
            { Value: 1, Label: { UserLocalizedLabel: { Label: "Option 1" } } },
            { Value: 2, Label: { UserLocalizedLabel: { Label: "Option 2" } } },
            { Value: 3, Label: { UserLocalizedLabel: { Label: "Option 3" } } },
        ],
    };
    var sample_Choices = {
        "@odata.type": "#Microsoft.Dynamics.CRM.MultiSelectPicklistAttributeMetadata",
        EntityLogicalName: "sample_customtable",
        LogicalName: "sample_choices",
        AttributeType: "MultiPicklist",
        OptionSet: sample_Choices_Values,
    };
    var columns_values_CustomTable1 = [sample_Choices];

    var sample_Choice_Values = {
        OptionSetType: "Picklist",
        Options: [
            { Value: 0, Label: { UserLocalizedLabel: { Label: "A" } } },
            { Value: 727000001, Label: { UserLocalizedLabel: { Label: "B" } } },
            { Value: 727000002, Label: { UserLocalizedLabel: { Label: "C" } } },
        ],
    };
    var sample_Choice = {
        "@odata.type": "#Microsoft.Dynamics.CRM.PicklistAttributeMetadata",
        ...
        LogicalName: "sample_choice",
        AttributeType: "Picklist",
        OptionSet: sample_Choice_Values,
    };
    var columns_values_CustomTable2 = [sample_Choice];

    var sample_State_Values = {
        OptionSetType: "State",
        Options: [
    ...
    columns_CustomTable.push({
        ...
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Two Options" } },
    });
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.MultiSelectPicklistAttributeMetadata",
        SchemaName: "sample_Choices",
        LogicalName: "sample_choices",
        IsPrimaryId: false,
        IsPrimaryName: false,
        AttributeType: "Virtual",
        ...
        IsValidForCreate: true,
        IsValidForUpdate: true,
        DisplayName: { UserLocalizedLabel: { Label: "Choices" } },
    });
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.FileAttributeMetadata",
        SchemaName: "sample_File",
        LogicalName: "sample_file",
        IsPrimaryId: false,
        IsPrimaryName: false,
        AttributeType: "Virtual",
        IsValidForRead: true,
    ...
    columns_CustomTable.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.StringAttributeMetadata",
        SchemaName: "sample_File_Name",
        LogicalName: "sample_file_name",
        AttributeOf: "sample_file",
        AttributeType: "String",
        IsValidForCreate: false,
        IsValidForRead: true,
        IsValidForUpdate: false,
    ...
    keys_CustomTable.push({
        SchemaName: "sample_SampleKey1",
        LogicalName: "sample_samplekey1",
        EntityKeyIndexStatus: "Active",
        KeyAttributes: ["sample_name"],
        DisplayName: { UserLocalizedLabel: { Label: "Sample Key 1" } },
    });
    keys_CustomTable.push({
        SchemaName: "sample_SampleKey2",
        LogicalName: "sample_samplekey2",
        EntityKeyIndexStatus: "Active",
        KeyAttributes: ["sample_name", "sample_name2"],
        DisplayName: { UserLocalizedLabel: { Label: "Sample Key 2" } },
    });
    keys_CustomTable.push({
        SchemaName: "sample_SampleKey3",
        LogicalName: "sample_samplekey3",
        EntityKeyIndexStatus: "Active",
        KeyAttributes: ["sample_name2", "sample_choice", "sample_wholenumber", "sample_contactid", "sample_decimal", "sample_dateandtime"],
        DisplayName: { UserLocalizedLabel: { Label: "Sample Key 3" } },
    });

    var oneToMany_CustomTable = [];
    oneToMany_CustomTable.push({
        SchemaName: "sample_sample_customtable_Team",
        ReferencingEntity: "team",
        ReferencedEntity: "sample_customtable",
        ReferencingAttribute: "sample_customtableid",
        ReferencedAttribute: "sample_customtableid",
        ReferencingEntityNavigationPropertyName: "sample_CustomTableId",
        ReferencedEntityNavigationPropertyName: "sample_sample_customtable_Team",
    });
    oneToMany_CustomTable.push({
        SchemaName: "sample_sample_customtable_team_CustomTable2",
        ReferencingEntity: "team",
        ReferencedEntity: "sample_customtable",
        ReferencingAttribute: "sample_customtable2",
        ReferencedAttribute: "sample_customtableid",
        ReferencingEntityNavigationPropertyName: "sample_CustomTable2",
        ReferencedEntityNavigationPropertyName: "sample_sample_customtable_team_CustomTable2",
    });
    oneToMany_CustomTable.push({
        SchemaName: "sample_sample_customtable_Account",
        ReferencingEntity: "account",
        ReferencedEntity: "sample_customtable",
        ReferencingAttribute: "sample_customtableid",
        ReferencedAttribute: "sample_customtableid",
        ReferencingEntityNavigationPropertyName: "sample_CustomTableId",
        ReferencedEntityNavigationPropertyName: "sample_sample_customtable_Account",
    });

    var manyToOne_CustomTable = [];
    manyToOne_CustomTable.push({
        SchemaName: "sample_account_sample_customtable_Customer",
        ReferencingEntity: "sample_customtable",
        ReferencedEntity: "account",
        ReferencingAttribute: "sample_customerid",
        ReferencedAttribute: "accountid",
        ReferencingEntityNavigationPropertyName: "sample_CustomerId_account",
        ReferencedEntityNavigationPropertyName: "sample_account_sample_customtable_Customer",
    });
    manyToOne_CustomTable.push({
        SchemaName: "sample_contact_sample_customtable_Customer",
        ReferencingEntity: "sample_customtable",
        ReferencedEntity: "contact",
        ReferencingAttribute: "sample_customerid",
        ReferencedAttribute: "contactid",
        ReferencingEntityNavigationPropertyName: "sample_CustomerId_contact",
        ReferencedEntityNavigationPropertyName: "sample_contact_sample_customtable_Customer",
    });

    var manyToMany_CustomTable = [];
    manyToMany_CustomTable.push({
        Entity1LogicalName: "sample_customtable",
        Entity2LogicalName: "sample_customtable",
    ...
    manyToMany_CustomTable.push({
        ...
        Entity1NavigationPropertyName: "sample_sample_customtable_Contact1",
        Entity2NavigationPropertyName: "sample_sample_customtable_Contact1",
        SchemaName: "sample_sample_customtable_Contact1",
    });
    manyToMany_CustomTable.push({
        Entity1LogicalName: "account",
        Entity2LogicalName: "sample_customtable",
        Entity1NavigationPropertyName: "sample_account_sample_customTable1",
        Entity2NavigationPropertyName: "sample_account_sample_customTable1",
        SchemaName: "sample_account_sample_customTable1",
    });

    var columns_CustomTable2 = [];

    columns_CustomTable2.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.StringAttributeMetadata",
        SchemaName: "new_Name",
        ...
        IsValidForUpdate: true,
        MaxLength: 80,
        DisplayName: { UserLocalizedLabel: { Label: "Name (New)" } },
    });
    columns_CustomTable2.push({
        "@odata.type": "#Microsoft.Dynamics.CRM.StringAttributeMetadata",
        SchemaName: "new_Name2",
        LogicalName: "new_name2",
        IsPrimaryId: false,
        IsPrimaryName: false,
        AttributeType: "String",
        IsValidForRead: true,
        ...
        IsValidForUpdate: true,
        MaxLength: 80,
        DisplayName: { UserLocalizedLabel: { Label: "New Name 2 (New)" } },
    });

    var keys_CustomTable2 = [];
    keys_CustomTable2.push({
        SchemaName: "new_SampleKey1",
        LogicalName: "new_samplekey1",
        EntityKeyIndexStatus: "Active",
        KeyAttributes: ["new_name"],
        DisplayName: { UserLocalizedLabel: { Label: "Sample Key 1 (New)" } },
    });
    keys_CustomTable2.push({
        SchemaName: "new_SampleKey2",
        LogicalName: "new_samplekey2",
        EntityKeyIndexStatus: "Active",
        KeyAttributes: ["new_name", "new_name2"],
        DisplayName: { UserLocalizedLabel: { Label: "Sample Key 2 (New)" } },
    });
    ...
    queries.forEach(function (query) {
        if (query.EntitySetName.indexOf("contact") > -1) {
            ...
            var fakeColumns = [];
            columns_Contact.forEach(function (column) {
                fakeColumns.push(column);
            });
        ...
        if (query.EntitySetName.indexOf("team") > -1) {
            ...
            var fakeColumns = [];
            columns_Team.forEach(function (column) {
                fakeColumns.push(column);
            });
            fakeDataQuery.Attributes = fakeColumns;
            fakeData += fakeHeaderStart + JSON.stringify(fakeDataQuery) + emptyLine;
        ...
        if (query.EntitySetName.indexOf("account") > -1) {
            ...
            var fakeColumns = [];
            columns_Account.forEach(function (column) {
                fakeColumns.push(column);
            });
            fakeDataQuery.Attributes = fakeColumns;
            var fakeOneToMany = [];
            oneToMany_Account.forEach(function (relationship) {
                fakeOneToMany.push(relationship);
            });
        ...
        if (query.EntitySetName.indexOf("systemuser") > -1) {
            ...
            var fakeColumns = [];
            columns_User.forEach(function (column) {
                fakeColumns.push(column);
            });
            fakeDataQuery.Attributes = fakeColumns;
            fakeData += fakeHeaderStart + JSON.stringify(fakeDataQuery) + emptyLine;
        ...
        if (query.EntitySetName.indexOf("sample_customtable") > -1) {
            if (query.Filters.indexOf("$expand=OptionSet") === -1) {
                ...
                var fakeColumns = [];
                columns_CustomTable.forEach(function (column) {
                    fakeColumns.push(column);
                });
                fakeDataQuery.Attributes = fakeColumns;
                var fakeKeys = [];
                keys_CustomTable.forEach(function (key) {
                    fakeKeys.push(key);
                });
                fakeDataQuery.Keys = fakeKeys;
                var fakeOneToMany = [];
                oneToMany_CustomTable.forEach(function (relationship) {
                    fakeOneToMany.push(relationship);
                });
                fakeDataQuery.OneToManyRelationships = fakeOneToMany;
                var fakeManyToOne = [];
                manyToOne_CustomTable.forEach(function (relationship) {
                    fakeManyToOne.push(relationship);
                });
                fakeDataQuery.ManyToOneRelationships = fakeManyToOne;
                var fakeManyToMany = [];
                manyToMany_CustomTable.forEach(function (relationship) {
                    fakeManyToMany.push(relationship);
                });
        ...
        if (query.EntitySetName.indexOf("new_customtable") > -1) {
            ...
            var fakeColumns = [];
            columns_CustomTable2.forEach(function (column) {
                fakeColumns.push(column);
            });
            fakeDataQuery.Attributes = fakeColumns;
            var fakeKeys = [];
            keys_CustomTable2.forEach(function (key) {
                fakeKeys.push(key);
            });
            fakeDataQuery.Keys = fakeKeys;
            fakeData += fakeHeaderStart + JSON.stringify(fakeDataQuery) + emptyLine;
        ...
        if (query.EntitySetName.indexOf("customapis") > -1) {
            var fakeDataQuery = {
                value: [{ bindingtype: 0, boundentitylogicalname: null, name: "FetchXMLToSQL", uniquename: "FetchXMLToSQL", isfunction: true }],
            };
            fakeData += fakeHeaderStart + JSON.stringify(fakeDataQuery) + emptyLine;
        }
    ...
    if (fakeData === fakeHeaderEnd) {
        fakeData = fakeHeaderStart + emptyLine + fakeHeaderEnd;
    }
...
DRB.Models.Records = function (records) {
    ...
    this.ToDropdown = function () {
        ...
        this.Records.forEach(function (record) {
            recordsDropdown.push(record.ToDropdownOption());
        });
...
DRB.Models.IdValue = function (id, value) {
    ...
    this.ToDropdownOption = function () {
        return new DRB.Models.DropdownOption(this.Id, this.Value);
    };
};
...
DRB.Models.Relationship = function (schemaName, type, sourceTable, targetTable, navigationProperty, navigationAttribute) {
    ...
    this.ToDropdownOption = function () {
        ...
        switch (this.Type) {
            case "OneToMany":
                subText += " - Target: " + this.NavigationAttributeName + " (" + this.NavigationAttribute + ")";
                break;
            case "ManyToOne":
                subText += " - Source: " + this.NavigationAttributeName + " (" + this.NavigationAttribute + ")";
                break;
        }
...
DRB.Models.SimpleRelationship = function (schemaName, type, sourceTable, targetTable, navigationAttribute, navigationAttributeName) {
    ...
    if (!DRB.Utilities.HasValue(this.NavigationAttribute)) {
        this.NavigationAttribute = "";
    }
 ...
 */
DRB.Models.RelationshipColumn = function (
    relationshipSchemaName,
    relationshipType,
    relationshipNavigationProperty,
    relationshipNavigationAttribute,
    relationshipNavigationAttributeName,
    ...
    columnSchemaName,
    columnAttributeType,
    columnIsPrimaryIdAttribute,
    columnIsPrimaryNameAttribute,
    columnRequiredLevel,
    ...
    this.ToDropdownOption = function () {
        ...
        switch (this.RelationshipType) {
            case "OneToMany":
                subText2 += " - Target: " + this.RelationshipNavigationAttributeName + " (" + this.RelationshipNavigationAttribute + ")";
                break;
            case "ManyToOne":
                subText2 += " - Source: " + this.RelationshipNavigationAttributeName + " (" + this.RelationshipNavigationAttribute + ")";
                break;
        }
    ...
    this.ToDropdownOption = function () {
        ...
        switch (this.AttributeType) {
            case "Uniqueidentifier":
                renamedAttributeType = "Guid";
                break;
            case "Picklist":
                renamedAttributeType = "Choice";
                break;
            case "MultiPicklist":
                renamedAttributeType = "Choices";
                break;
            case "DateTime":
                renamedAttributeType = "Date Time";
                break;
            case "Double":
                renamedAttributeType = "Float";
                break;
            case "Integer":
                renamedAttributeType = "Whole Number";
                break;
            case "Memo":
                renamedAttributeType = "Multiline Text";
                break;
            case "String":
                renamedAttributeType = "Text";
                break;
            case "Money":
                renamedAttributeType = "Currency";
                break;
            case "BigInt":
        ...
        if (this.RequiredLevel === "ApplicationRequired" || this.RequiredLevel === "SystemRequired") {
            subText += " *";
        }
...
DRB.Models.DataverseMember = function (name, value) {
    ...
    this.ToDropdownOption = function () {
        return new DRB.Models.DropdownOption(this.Id, this.Name, this.Value);
    };
};
...
DRB.UI.FillDropdown = function (id, title, options, disabledOptions, showGroups, hideSubText, size) {
    ...
    if (showGroups === true) {
        ...
        options.forEach(function (dropOption) {
            if (groups.indexOf(dropOption.SubText) === -1) {
                groups.push(dropOption.SubText);
            }
        });
        groups.sort();
    } else {
        groups.push("No Groups");
    } // we need at least an element for the next forEach

    groups.forEach(function (group) {
        if (showGroups === true) {
            htmlOptions += '<optgroup label="' + group + '">';
        }
        options.forEach(function (dropOption) {
            if (dropOption.SubText == group || showGroups !== true) {
                htmlOptions += '<option value="' + dropOption.Value + '"';
                var showSubText = false;
                if (DRB.Utilities.HasValue(dropOption[subTextProperty])) {
                    showSubText = true;
                }

                if (showSubText === true && hideSubText !== true) {
                    htmlOptions += ' data-subtext="' + dropOption[subTextProperty] + '"';
                }
                if (disabledOptions === true) {
...
DRB.UI.DisplayDialog = function (title, message, className, size, okCallBack, askQuestion, confirmLabel, cancelLabel) {
    ...
    if (DRB.Utilities.HasValue(title)) {
    ...
    if (!DRB.Utilities.HasValue(className)) {
    ...
    if (DRB.Utilities.HasValue(okCallBack) && askQuestion === true) {
        ...
        if (!DRB.Utilities.HasValue(confirmLabel)) {
            confirmLabel = "Yes";
        }
        if (!DRB.Utilities.HasValue(cancelLabel)) {
            cancelLabel = "No";
        }
        properties.buttons = { cancel: { label: cancelLabel }, confirm: { label: confirmLabel, className: className } };
        properties.callback = function (result) {
            if (result === true) {
                okCallBack();
            }
        };
...
DRB.UI.ShowLoading = function (message, size) {
    var loadingMessage =
        '<p class="text-center mb-0">' + message + '</p><br /><div class="d-flex justify-content-center"><div class="spinner-border spinner-border-sm" role="status"><span class="sr-only"></span></div></div>';
...
DRB.UI.CreateInputFile = function (id, hidden, event) {
    ...
    return $("<input>", { id: id, type: "file", style: "display: " + displayStyle }).on("change", function (e) {
        event(e);
    });
};
...
DRB.UI.CreateLookup = function (id, event, parameter) {
    return $("<button>", { id: id, class: "searchbutton" })
        .click(function () {
            event(parameter);
        })
        .append($("<span>", { "aria-hidden": true, html: "&telrec;" }));
};
...
DRB.UI.CreateUpButton = function (id, event, parameter, parameter2, parameter3, parameter4, parameter5, parameter6) {
    return $("<button>", { id: id, class: "closebutton" })
        .click(function () {
            event(parameter, parameter2, parameter3, parameter4, parameter5, parameter6);
        })
        .append($("<span>", { html: "&uarr;" }));
};
...
DRB.UI.CreateTextArea = function (id, className) {
    ...
    if (DRB.Utilities.HasValue(id)) {
        textAreaProperties.id = id;
    }
    if (DRB.Utilities.HasValue(className)) {
        textAreaProperties.class = className;
    }
...
DRB.UI.CreateInput = function (id, placeholder, maxLength, width) {
    ...
    if (!DRB.Utilities.HasValue(width)) {
        width = "100%";
    }
...
DRB.UI.CreateInputDateTime = function (id, behavior, placeholder) {
    ...
    return $("<input>", {
        id: id,
        readonly: "readonly",
        "data-datetimebehavior": behavior,
        class: "form-control",
        style: "width: 340px; height: 28px; margin-left: 10px; display: inline;",
        type: "text",
        autocomplete: "off",
...
DRB.UI.CreateInputMemo = function (id, maxLength, placeholder) {
    ...
    return $("<textarea>", {
        id: id,
        class: "form-control",
        style: "width: 340px; height: 34px; margin-left: 10px; display: inline;",
        type: "text",
        autocomplete: "off",
        maxlength: maxLength,
        title: placeholder,
...
DRB.UI.CreateInputNextLink = function (id) {
    return $("<input>", {
        id: id,
        class: "form-control",
        style: "width: 90%; height: 28px; margin-left: 10px; display: inline;",
        type: "text",
        autocomplete: "off",
        title: "@odata.nextLink url",
        placeholder: "@odata.nextLink url",
    });
};
...
DRB.UI.CreateDropdown = function (id, multiSelect, actionBox) {
    ...
    if (multiSelect === true) {
        ...
        if (actionBox === true) {
            selectProperties["data-actions-box"] = "true";
        }
    }
...
DRB.UI.OpenLookup = function (settings) {
    ...
    if (settings.openWorkflow === true) {
        if (DRB.Utilities.HasValue(DRB.Metadata.QueryObjectTypeCode)) {
            lookupOptions = {
                defaultEntityType: "workflow",
                entityTypes: ["workflow"],
                allowMultiSelect: false,
                filters: [
                    {
                        filterXml:
                            "<filter type='and'><condition attribute='statecode' operator='eq' value='1' /><condition attribute='ondemand' operator='eq' value='1' /><condition attribute='primaryentity' operator='eq' value='" +
                            DRB.Metadata.QueryObjectTypeCode +
                            "' /></filter>",
    ...
    if (DRB.Utilities.HasValue(lookupOptions)) {
        ...
        DRB.Xrm.GetXrmObject()
            ...
            .then(
                ...
                function (error) {
                    DRB.UI.ShowError("Xrm.Utility.lookupObjects Error", error);
                },
            );
    } else {
...
DRB.Xrm.GetVersion = function () {
    var currentVersion = "";
    if (DRB.Xrm.IsXTBMode()) {
        currentVersion = DRB.Settings.XTBVersion;
    }
    if (DRB.Xrm.IsJWTMode()) {
    ...
    if (DRB.Xrm.IsDemoMode()) {
        currentVersion = "9.1.0.0";
    }

    if (!DRB.Utilities.HasValue(currentVersion)) {
        return "";
    }
...
DRB.Xrm.RetrieveBatches = function (batchedQueries) {
    ...
    batchedQueries.forEach(function (batchedQuery) {
        var queries = [];
        batchedQuery.forEach(function (query) {
            queries.push(query);
        });
...
DRB.Common.RetrieveTablesDetails = function (tableLogicalNames, includeRelationships, includeAlternateKeys) {
    ...
    } // Alternate Key supports Picklist, retrieving Option Values is required
    ...
    for (var count = 0; count < tableLogicalNames.length; count++) {
        if (count % tableBatchSize === 0) {
            batchedTableLogicalNames.push([]);
        }
...
DRB.Common.SetTables = function (args, tables, mapRelationships, mapAlternateKeys) {
    ...
    if (mapAlternateKeys === true) {
        mapOptionValues = true;
    } // if map Alternate Keys map also Option Values (Alternate Key supports Picklist)

    var datas = [];
    if (Array.isArray(args[0])) {
        // multiple batches
        for (var count = 0; count < args.length; count++) {
            datas.push(args[count][0]);
        }
    } else {
        // single batch
        datas.push(args[0]);
    ...
    datas.forEach(function (data) {
        ...
        contexts.forEach(function (context) {
            ...
            if (DRB.Utilities.HasValue(tableLogicalName)) {
                ...
                contextsToCheckOptionValues.push(context);
            }
        });

        if (mapOptionValues === true) {
            contextsToCheckOptionValues.forEach(function (context) {
                if (DRB.Utilities.HasValue(context.value)) {
                    DRB.Common.MapOptionValues(context.value);
                }
            });
        }
    });
...
DRB.Common.MapTables = function (data, sortProperty) {
    ...
    if (Array.isArray(data.value)) {
        data.value.forEach(function (record) {
            ...
            if (DRB.Utilities.HasValue(record.DisplayName) && DRB.Utilities.HasValue(record.DisplayName.UserLocalizedLabel) && DRB.Utilities.HasValue(record.DisplayName.UserLocalizedLabel.Label)) {
                name = record.DisplayName.UserLocalizedLabel.Label;
            }
        ...
        if (DRB.Utilities.HasValue(sortProperty)) {
            tables.sort(DRB.Utilities.CustomSort(sortProperty));
        }
    }
    // return the array
    return tables;
...
DRB.Common.MapColumns = function (data, primaryIdAttribute, primaryNameAttribute, sortProperty) {
    ...
    if (Array.isArray(data)) {
        ...
        data.forEach(function (record) {
            ...
            if (DRB.Utilities.HasValue(record.RequiredLevel) && DRB.Utilities.HasValue(record.RequiredLevel.Value)) {
                requiredLevel = record.RequiredLevel.Value;
            }
            ...
            if (DRB.Utilities.HasValue(record.DateTimeBehavior) && DRB.Utilities.HasValue(record.DateTimeBehavior.Value)) {
                dateTimeBehavior = record.DateTimeBehavior.Value;
            }
            ...
            if (oDataType === "#Microsoft.Dynamics.CRM.FileAttributeMetadata") {
                attributeType = "File";
                fileColumns.push(logicalName);
            }
            if (oDataType === "#Microsoft.Dynamics.CRM.EntityNameAttributeMetadata") {
                // check if logical name ends with "type"
                if (logicalName.length > 4 && logicalName.substring(logicalName.length - 4) === "type") {
                    polyTypeColumns.push(attributeOf);
                }
            }
            if (oDataType === "#Microsoft.Dynamics.CRM.ImageAttributeMetadata") {
                attributeType = "Image";
                imageColumns.push(attributeOf);
                imageNameColumns.push(name);
                attributeOf = null;
            }
            ...
            if (logicalName === primaryIdAttribute) {
                ...
                if (logicalName === primaryNameAttribute) {
            ...
            if (column.IsValidForRead === true && column.AttributeType !== "PartyList") {
                if (column.AttributeOf == null) {
                    ...
                    if (imageColumns.indexOf(column.LogicalName) > -1) {
                        column.Name = imageNameColumns[imageColumns.indexOf(column.LogicalName)] + " (ID)";
                    }
                    ...
                    if (fileColumns.indexOf(column.AttributeOf) > -1) {
                        ...
                        if (DRB.Utilities.HasValue(fileColumn)) {
                            ...
                            if (column.Name.lastIndexOf("_") > -1 && column.Name.length - 1 > column.Name.lastIndexOf("_")) {
                                additionalProperty = column.Name.substring(column.Name.lastIndexOf("_") + 1);
                            }
        ...
        selectedColumns.forEach(function (column) {
            if (column.AttributeType === "Lookup" && polyTypeColumns.indexOf(column.LogicalName) > -1) {
                column.AdditionalProperties.IsPolymorphic = true;
            }
        });

        // sort the array based on the provided sortProperty
        if (DRB.Utilities.HasValue(sortProperty)) {
            selectedColumns.sort(DRB.Utilities.CustomSort(sortProperty));
        }
        // add Primary Id column to the top of the list
        if (DRB.Utilities.HasValue(primaryIdColumn)) {
            selectedColumns.unshift(primaryIdColumn);
        }
    }
    // return the array
            ...
            if (DRB.Utilities.HasValue(currentTable)) {
                ...
                if (DRB.Utilities.HasValue(currentColumn)) {
                    ...
                    if (currentColumn.AttributeType === "Boolean") {
                        var falseLabel = "No";
                        if (
                            DRB.Utilities.HasValue(contextValue.OptionSet.FalseOption) &&
                            DRB.Utilities.HasValue(contextValue.OptionSet.FalseOption.Label) &&
                            DRB.Utilities.HasValue(contextValue.OptionSet.FalseOption.Label.UserLocalizedLabel) &&
                            DRB.Utilities.HasValue(contextValue.OptionSet.FalseOption.Label.UserLocalizedLabel.Label)
                        ) {
                            falseLabel = contextValue.OptionSet.FalseOption.Label.UserLocalizedLabel.Label;
                        }

                        var trueLabel = "Yes";
                        if (
                            DRB.Utilities.HasValue(contextValue.OptionSet.TrueOption) &&
                            DRB.Utilities.HasValue(contextValue.OptionSet.TrueOption.Label) &&
                            DRB.Utilities.HasValue(contextValue.OptionSet.TrueOption.Label.UserLocalizedLabel) &&
                            DRB.Utilities.HasValue(contextValue.OptionSet.TrueOption.Label.UserLocalizedLabel.Label)
                        ) {
                            trueLabel = contextValue.OptionSet.TrueOption.Label.UserLocalizedLabel.Label;
                        }
                        ...
                        contextValue.OptionSet.Options.forEach(function (contextValueOption) {
                            ...
                            if (
                                DRB.Utilities.HasValue(contextValueOption.Label) &&
                                DRB.Utilities.HasValue(contextValueOption.Label.UserLocalizedLabel) &&
                                DRB.Utilities.HasValue(contextValueOption.Label.UserLocalizedLabel.Label)
                            ) {
                                optionLabel = contextValueOption.Label.UserLocalizedLabel.Label;
                            }
...
DRB.Common.MapAlternateKeys = function (data, sortProperty) {
    ...
    if (Array.isArray(data)) {
        ...
        // sort the array based on the provided sortProperty
        if (DRB.Utilities.HasValue(sortProperty)) {
            alternateKeys.sort(DRB.Utilities.CustomSort(sortProperty));
        }
    }
    // return the array
...
DRB.Common.MapRelationships = function (data, type, sortProperty, sourceTable) {
    ...
    if (Array.isArray(data)) {
            ...
            switch (type) {
                ...
                case "ManyToMany":
                    ...
                    if (targetTable === sourceTable) {
                        targetTable = entity1LogicalName;
                    }
        ...
        // sort the array based on the provided sortProperty
        if (DRB.Utilities.HasValue(sortProperty)) {
            relationships.sort(DRB.Utilities.CustomSort(sortProperty));
        }
    }
    // return the array
...
DRB.Common.MapCustomAPIs = function (data, sortProperty) {
    ...
    if (Array.isArray(data.value)) {
        data.value.forEach(function (record) {
            ...
            if (bindingType === 1 || bindingType === 2) {
                isBound = true;
                logicalName = record.boundentitylogicalname;
            }
            if (bindingType === 2) {
        ...
        // sort the array based on the provided sortProperty
        if (DRB.Utilities.HasValue(sortProperty)) {
            customAPIs.sort(DRB.Utilities.CustomSort(sortProperty));
        }
    }
    // return the array
    return customAPIs;
        ...
        data.value.forEach(function (record) {
            ...
            if (DRB.Utilities.HasValue(customAPI)) {
                ...
                switch (parameterType) {
                    case 0:
                        parameterType = "Edm.Boolean";
                        break;
                    case 1:
                        parameterType = "Edm.DateTimeOffset";
                        break;
                    case 2:
                        parameterType = "Edm.Decimal";
                        break;
                    case 3:
                        parameterType = "mscrm.crmbaseentity";
                        break; // Entity
                    case 4:
                        parameterType = "Collection(mscrm.crmbaseentity)";
                        break; // EntityCollection
                    case 5:
                        parameterType = "mscrm.crmbaseentity";
                        break; // EntityReference
                    case 6:
                        parameterType = "Edm.Double";
                        break;
                    case 7:
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        parameterType = "Collection(Edm.String)";
                        break; // StringArray
                    case 12:
                        parameterType = "Edm.Guid";
                        break;
                }
            ...
            if (DRB.Utilities.HasValue(customAPI)) {
                ...
                switch (propertyType) {
                    case 0:
                        ...
                        break;
                    case 1:
                        propertyType = "Edm.DateTimeOffset";
                        break;
                    case 2:
                        propertyType = "Edm.Decimal";
                        break;
                    case 3:
                        propertyType = "mscrm.crmbaseentity";
                        break; // Entity
                    case 4:
                        propertyType = "Collection(mscrm.crmbaseentity)";
                        break; // EntityCollection
                    case 5:
                        propertyType = "mscrm.crmbaseentity";
                        break; // EntityReference
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        propertyType = "Collection(Edm.String)";
                        break; // StringArray
                    case 12:
                        propertyType = "Edm.Guid";
                        break;
                }
...
DRB.Common.MapCustomActions = function (data, sortProperty) {
    ...
    if (Array.isArray(data.value)) {
        ...
        // sort the array based on the provided sortProperty
        if (DRB.Utilities.HasValue(sortProperty)) {
            customActions.sort(DRB.Utilities.CustomSort(sortProperty));
        }
    }
    // return the array
    return customActions;
        ...
        customActions.forEach(function (customAction) {
            ...
            parameters.forEach(function (parameter, parameterIndex) {
                if (parameterIndex > 0) {
                    ...
                    if (newParameters[newParameters.length - 1].Position !== parameter.Position) {
                        newParameters.push(parameter);
                    }
                } else {
    ...
    if (Array.isArray(data.value)) {
        ...
        customActions.forEach(function (customAction) {
            ...
            properties.forEach(function (property, propertyIndex) {
                if (propertyIndex > 0) {
                    // check if the current position is different from the last stored inside newParameters
                    if (newProperties[newProperties.length - 1].Position !== property.Position) {
                        newProperties.push(property);
                    }
                } else {
                    // first element copy directly
...
DRB.Common.GetErrorMessage = function (xhr) {
    try {
        var printedContent = JSON.stringify(xhr.responseText, null, "!!")
            .replace(/!!/g, "&nbsp;&nbsp;")
            .replace(/(?:\r\n|\r|\n)/g, "<br />");
...
DRB.Common.ExtractIndexFromControlName = function (controlName) {
    ...
    if (!DRB.Utilities.HasValue(controlName)) {
        return -1;
    }
    var lastUnderscore = controlName.lastIndexOf("_");
    if (lastUnderscore > -1 && lastUnderscore + 1 < controlName.length) {
        return parseInt(controlName.substring(lastUnderscore + 1));
    } else {
        return -1;
    }
};
...
DRB.Common.BindGuid = function (id) {
    $("#" + id).on("input", function (e) {
        $(this).val(function (i, v) {
            ...
            if (finalGuid.length > 8) {
                finalGuid = finalGuid.substring(0, 8) + "-" + finalGuid.substring(8);
            }
            if (finalGuid.length > 13) {
                finalGuid = finalGuid.substring(0, 13) + "-" + finalGuid.substring(13);
            }
            if (finalGuid.length > 18) {
                finalGuid = finalGuid.substring(0, 18) + "-" + finalGuid.substring(18);
            }
            if (finalGuid.length > 23) {
                finalGuid = finalGuid.substring(0, 23) + "-" + finalGuid.substring(23);
            }
            if (finalGuid.length === 36) {
...
DRB.Common.BindInteger = function (id, minValue, maxValue) {
    $("#" + id).on("input", function (e) {
        $(this).val(function (i, v) {
            ...
            if (finalNumber < minValue || finalNumber > maxValue || finalNumber == "-") {
                $(this).removeClass("is-valid");
                $(this).addClass("is-invalid");
            } else {
                $(this).removeClass("is-invalid");
...
DRB.Common.BindNumber = function (id, minValue, maxValue) {
    $("#" + id).on("input", function (e) {
        $(this).val(function (i, v) {
            ...
            if (finalNumber < minValue || finalNumber > maxValue || finalNumber == "-" || finalNumber == "." || finalNumber == "-.") {
                $(this).removeClass("is-valid");
                $(this).addClass("is-invalid");
            } else {
                $(this).removeClass("is-invalid");
...
DRB.Logic.MoveCodeToMainEditor = function (sectionName) {
    ...
    switch (sectionName) {
        case "code_xrmwebapi":
            codeValue = DRB.Settings.XrmWebApiEditor.session.getValue();
            break;
        case "code_xrmwebapiexecute":
            codeValue = DRB.Settings.XrmWebApiExecuteEditor.session.getValue();
            break;
        case "code_jquery":
            codeValue = DRB.Settings.jQueryEditor.session.getValue();
            break;
...
DRB.Logic.CopyCodeFromEditor = function (sectionName) {
    ...
    switch (sectionName) {
        ...
        case "code_portals":
            ...
            break;
        case "code_editor":
            codeValue = DRB.Settings.MainEditor.session.getValue();
            break;
        case "code_results":
            codeValue = DRB.Settings.ResultsEditor.session.getValue();
            contentText = "Results";
            break;
    }
    // copy to clipboard
...
DRB.Logic.EditRequest = function (node) {
    if (node.type === "request") {
        ...
        if (!DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data)) {
            DRB.Metadata.CurrentNode.data = { endpoint: "webapi", requestType: "", configuration: {} };
        }
        if (!DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.requestType)) {
            DRB.Metadata.CurrentNode.data.requestType = "";
            DRB.Metadata.CurrentNode.data.configuration = {};
        }
        if (!DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.configuration)) {
            DRB.Metadata.CurrentNode.data.configuration = {};
        }

        $("#" + DRB.DOM.RequestType.Div.Id).text(DRB.Metadata.CurrentNode.text); // Set the request name inside the main content
        $("#" + DRB.DOM.RequestType.Dropdown.Id)
            .val(DRB.Metadata.CurrentNode.data.requestType)
            .change(); // trigger the Request Type dropdown
...
DRB.Logic.BindRequestType = function (id) {
    $("#" + id).on("change", function (e) {
        ...
        var showTabs = false;
        if (DRB.Utilities.HasValue(requestTypeValue)) {
            showTabs = true;
        }
        ...
        if (!DRB.Utilities.HasValue(nodeConfiguration.version)) {
            nodeConfiguration.version = DRB.Settings.Versions[DRB.Settings.Versions.length - 1].Id;
        } // All except Retrieve NextLink
        if (!DRB.Utilities.HasValue(nodeConfiguration.async)) {
            nodeConfiguration.async = true;
        } // All
        if (!DRB.Utilities.HasValue(nodeConfiguration.tokenHeader)) {
            nodeConfiguration.tokenHeader = false;
        } // All
        ...
        if (!DRB.Utilities.HasValue(nodeConfiguration.formattedValues)) {
            nodeConfiguration.formattedValues = true;
        }
        if (!DRB.Utilities.HasValue(nodeConfiguration.returnRecord)) {
            nodeConfiguration.returnRecord = false;
        } // Create, Update
        if (!DRB.Utilities.HasValue(nodeConfiguration.detectDuplicates)) {
            nodeConfiguration.detectDuplicates = false;
        } // Create, Update
        if (!DRB.Utilities.HasValue(nodeConfiguration.detectChanges)) {
            nodeConfiguration.detectChanges = false;
        } // Retrieve Single, Retrieve NextLink
        if (!DRB.Utilities.HasValue(nodeConfiguration.retrieveCount)) {
            nodeConfiguration.retrieveCount = false;
        } // Retrieve Multiple, Retrieve NextLink, Predefined Query
        if (!DRB.Utilities.HasValue(nodeConfiguration.prevent)) {
            nodeConfiguration.prevent = "none";
        } // Update
        if (!DRB.Utilities.HasValue(nodeConfiguration.topCount)) {
            nodeConfiguration.topCount = "";
        } // Retrieve Multiple
        if (!DRB.Utilities.HasValue(nodeConfiguration.primaryEntity)) {
            nodeConfiguration.primaryEntity = null;
        } // All
        if (!DRB.Utilities.HasValue(nodeConfiguration.primaryIdField)) {
            nodeConfiguration.primaryIdField = "";
        }
        if (!DRB.Utilities.HasValue(nodeConfiguration.useAlternateKey)) {
            nodeConfiguration.useAlternateKey = false;
        }
        if (!DRB.Utilities.HasValue(nodeConfiguration.primaryId)) {
            nodeConfiguration.primaryId = "";
        }
        if (!DRB.Utilities.HasValue(nodeConfiguration.alternateKeyName)) {
            nodeConfiguration.alternateKeyName = "";
        }
        if (!DRB.Utilities.HasValue(nodeConfiguration.alternateKeyFields)) {
            nodeConfiguration.alternateKeyFields = [];
        }
        if (!DRB.Utilities.HasValue(nodeConfiguration.fields)) {
            nodeConfiguration.fields = [];
        } // Retrieve Single, Retrieve Multiple, Create, Update
        if (!DRB.Utilities.HasValue(nodeConfiguration.setFields)) {
            nodeConfiguration.setFields = [];
        } // Create, Update
        if (!DRB.Utilities.HasValue(nodeConfiguration.oneToMany)) {
            nodeConfiguration.oneToMany = [];
        } // Retrieve Single, Retrieve Multiple, Create, Update
        if (!DRB.Utilities.HasValue(nodeConfiguration.manyToOne)) {
            nodeConfiguration.manyToOne = [];
        } // Retrieve Single, Retrieve Multiple, Create, Update
        if (!DRB.Utilities.HasValue(nodeConfiguration.manyToMany)) {
            nodeConfiguration.manyToMany = [];
        } // Retrieve Single, Retrieve Multiple, Create, Update
        if (!DRB.Utilities.HasValue(nodeConfiguration.filterCriteria)) {
            nodeConfiguration.filterCriteria = {};
        } // Retrieve Multiple
        if (!DRB.Utilities.HasValue(nodeConfiguration.orderFields)) {
            nodeConfiguration.orderFields = [];
        } // Retrieve Multiple
        if (!DRB.Utilities.HasValue(nodeConfiguration.secondaryEntity)) {
            nodeConfiguration.secondaryEntity = null;
        } // Association
        if (!Array.isArray(nodeConfiguration.secondaryIds)) {
            nodeConfiguration.secondaryIds = [""];
        } // Association
        if (!DRB.Utilities.HasValue(nodeConfiguration.relationship)) {
            nodeConfiguration.relationship = "";
        } // Association
        if (!DRB.Utilities.HasValue(nodeConfiguration.nextLink)) {
            nodeConfiguration.nextLink = "";
        } // Retrieve NextLink
        if (!DRB.Utilities.HasValue(nodeConfiguration.queryType)) {
            nodeConfiguration.queryType = "";
        } // Predefined Query
        if (!DRB.Utilities.HasValue(nodeConfiguration.systemViewId)) {
            nodeConfiguration.systemViewId = "";
        } // Predefined Query
        if (!DRB.Utilities.HasValue(nodeConfiguration.personalViewId)) {
            nodeConfiguration.personalViewId = "";
        } // Predefined Query
        if (!DRB.Utilities.HasValue(nodeConfiguration.fetchXML)) {
            nodeConfiguration.fetchXML = "";
        } // Predefined Query
        if (!DRB.Utilities.HasValue(nodeConfiguration.workflowId)) {
            nodeConfiguration.workflowId = "";
        } // Execute Workflow
        if (!DRB.Utilities.HasValue(nodeConfiguration.dataverseExecute)) {
            nodeConfiguration.dataverseExecute = "";
        } // Dataverse Execute
        if (!DRB.Utilities.HasValue(nodeConfiguration.dataverseOperationType)) {
            nodeConfiguration.dataverseOperationType = 0;
        } // Dataverse Execute
        ...
        if (showTabs) {
            $("#" + DRB.DOM.TabsRequest.Id).show();
        } else {
            $("#" + DRB.DOM.TabsRequest.Id).hide();
        }
...
DRB.Logic.ExportRelationships = function (values, relationshipMetadata) {
    ...
    values.forEach(function (value) {
        relationships.push(value.split("|")[0]);
    });
    ...
    relationships.forEach(function (relationship) {
        ...
        values.forEach(function (selectedRelationshipColumn) {
            ...
            if (splitted[0] === relationship) {
                relationshipExport.fields.push({ logicalName: splitted[1] });
            }
        });
            ...
            if (DRB.Utilities.HasValue(targetTable)) {
                ...
                if (DRB.Utilities.HasValue(relationship.NavigationAttribute)) {
                    if (currentRelationship === "CurrentOneToMany") {
                        ...
                        if (DRB.Utilities.HasValue(relColumn)) {
                            relationship.NavigationAttributeName = relColumn.Name;
                        }
                    }
                ...
                targetTable.Columns.forEach(function (targetColumn) {
                    relationship.Columns.push(
                        new DRB.Models.RelationshipColumn(
                            relationship.SchemaName,
                            relationship.Type,
                            relationship.NavigationProperty,
                            relationship.NavigationAttribute,
                            relationship.NavigationAttributeName,
                            relationship.TargetTable,
                            targetTable.Name,
                            targetColumn.LogicalName,
                            targetColumn.Name,
                            targetColumn.SchemaName,
                            targetColumn.AttributeType,
                            targetColumn.IsPrimaryIdAttribute,
                            targetColumn.IsPrimaryNameAttribute,
                            targetColumn.RequiredLevel,
            ...
            DRB.Metadata.CurrentNode.data.configuration[configRel].forEach(function (relationship) {
                ...
                if (DRB.Utilities.HasValue(checkRelationship)) {
                    relationship.fields.forEach(function (relationshipField) {
                        ...
                        if (DRB.Utilities.HasValue(checkColumn)) {
                            relRecords.push(checkColumn);
                            configurationRelRecords.push(checkColumn.Id);
                        }
                    });
                }
            });
...
DRB.Logic.FillAlternateKeys = function () {
    ...
    if (DRB.Metadata.CurrentAlternateKeys.length === 0) {
        ...
        $("#" + DRB.DOM.UseAlternateKey.Dropdown.Id)
            .val("no")
            .change();
    } else {
        ...
        if (DRB.Metadata.CurrentNode.data.configuration.useAlternateKey === true) {
            $("#" + DRB.DOM.UseAlternateKey.Dropdown.Id)
                .val("yes")
                .change();
        }
        ...
        if (/\.(jpe?g|png|gif|bmp)$/i.test(file.name)) {
            ...
            reader.onload = function (e) {
                try {
                    ...
                    if (DRB.Utilities.HasValue(DRB.Metadata.CurrentImageIndex)) {
                        ...
                        DRB.Metadata.CurrentMetadataPath.split("_").forEach(function (path) {
                            if (isNaN(parseInt(path))) {
                                if (refMetadata.hasOwnProperty(path)) {
                                    refMetadata = refMetadata[path];
                                }
                                if (refConfiguration.hasOwnProperty(path)) {
                                    refConfiguration = refConfiguration[path];
                                }
                            } else {
                    ...
                    DRB.UI.ShowError("Load Image Error", "Failed to parse the selected file");
                }
            };
...
DRB.Logic.BindPropertyBooleanValue = function (id, property) {
    $("#" + id).on("change", function (e) {
        ...
        if (propertyBooleanValue === "yes") {
            DRB.Metadata.CurrentNode.data.configuration[property] = true;
        } else {
            DRB.Metadata.CurrentNode.data.configuration[property] = false;
        }
    });
};
    ...
    $("#" + id).on("change", function (e) {
        ...
        if (useAlternateKeyValue === "yes") {
            ...
            if (DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.configuration.alternateKeyName)) {
                ...
                $("#" + DRB.DOM.AlternateKey.Dropdown.Id)
                    .val(DRB.Metadata.CurrentNode.data.configuration.alternateKeyName)
                    .change();
            } else {
...
DRB.Logic.BindAlternateKeyValue = function (id) {
    $("#" + id).on("change", function (e) {
        ...
        if (controlName.indexOf("txt2_") === 0) {
            if (!DRB.Utilities.HasValue(currentField.value)) {
                currentField.value = {};
            }
        ...
        if (controlName.indexOf("cbx2_") === 0) {
            ...
            if (DRB.Utilities.HasValue(checkTable)) {
                tableSetName = checkTable.EntitySetName;
            }
            ...
            key.KeyAttributes.forEach(function (keyAttribute) {
                ...
                if (DRB.Utilities.HasValue(keyColumn)) {
                    if (allowedKeyTypes.indexOf(keyColumn.AttributeType) > -1) {
                        if (keyColumn.AdditionalProperties.IsPolymorphic === true) {
                            keyHasPolymorphicLookup = true;
                        }
                        ...
                        if (DRB.Utilities.HasValue(keyField)) {
                            ...
                            if (keyColumn.AttributeType === "Lookup") {
                                ...
                                if (DRB.Utilities.HasValue(keyField.value)) {
                                    if (DRB.Utilities.HasValue(keyField.value.id)) {
                                        lookupValue.id = keyField.value.id;
                                    }
                                    if (DRB.Utilities.HasValue(keyField.value.entityType)) {
                                        lookupValue.entityType = keyField.value.entityType;
                                    }
                                    if (DRB.Utilities.HasValue(keyField.value.entitySetName)) {
                                        lookupValue.entitySetName = keyField.value.entitySetName;
                                    }
                                }
                        ...
                        keyFields.push({
                            logicalName: keyColumn.LogicalName,
                            schemaName: keyColumn.SchemaName,
                            oDataName: keyColumn.ODataName,
                            label: keyColumn.Name,
                            type: keyColumn.AttributeType,
                            value: keyColumnValue,
                        });
                    }
                }
            });
                ...
                if (DRB.Utilities.HasValue(column)) {
                    ...
                    switch (field.type) {
                        case "Uniqueidentifier":
                            ...
                            $("#txt_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex)
                                .val(field.value)
                                .change();
                            break;
                        case "String":
                            divValue.append(
                                DRB.UI.CreateInputString("txt_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex, column.AdditionalProperties.MaxLength, "Max Length: " + column.AdditionalProperties.MaxLength),
                            );
                            DRB.Logic.BindAlternateKeyValue("txt_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex);
                            $("#txt_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex)
                                .val(field.value)
                        ...
                        case "Integer":
                            divValue.append(
                                DRB.UI.CreateInputNumber(
                                    "txt_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex,
                                    "Min Value: " + column.AdditionalProperties.MinValue + " - Max Value: " + column.AdditionalProperties.MaxValue,
                                ),
                            );
                        ...
                        case "Decimal":
                            divValue.append(
                                DRB.UI.CreateInputNumber(
                                    "txt_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex,
                                    "Min Value: " + column.AdditionalProperties.MinValue + " - Max Value: " + column.AdditionalProperties.MaxValue + " - Precision: " + column.AdditionalProperties.Precision,
                                ),
                            );
                        ...
                        case "Picklist":
                            ...
                            $("#cbx1_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex)
                                .val(field.value)
                                .change();
                            break;
                        ...
                        case "Lookup":
                            ...
                            if (DRB.Utilities.HasValue(field.value) && DRB.Utilities.HasValue(field.value.id)) {
                                $("#txt2_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex)
                                    .val(field.value.id)
                                    .change();
                            }
                            ...
                            if (column.AdditionalProperties.Targets.length > 0) {
                                ...
                                divValue.append(
                                    DRB.UI.CreateLookup("lkp_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex, DRB.UI.OpenLookup, {
                                        openCustom: true,
                                ...
                                if (DRB.Utilities.HasValue(field.value) && DRB.Utilities.HasValue(field.value.entityType)) {
                                    $("#cbx2_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex)
                                        .val(field.value.entityType)
                                        .change();
                                } else {
                                    $("#cbx2_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex)
                                        .val(targets[0].Id)
                        ...
                        case "DateTime":
                            ...
                            divValue.append(
                                DRB.UI.CreateInputDateTime("txtd_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex, dateTimeBehavior, "Behavior: " + clearedDateTimeBehavior + " - Format: " + clearedDateTimeFormat),
                            );
                            DRB.Logic.BindAlternateKeyValue("txtd_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex);
                            $("#txtd_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex)
                                .val(field.value)
                                .change();
                            $("#txtd_" + DRB.DOM.AlternateKey.ControlValue.Id + fieldIndex)
    ...
    $("#" + id).on("change", function (e) {
        ...
        if (DRB.Utilities.HasValue(selectedRelationship)) {
            ...
            selectedRelationship.Columns.forEach(function (rc) {
                var rcColumn = new DRB.Models.Column(
                    rc.ColumnLogicalName,
                    rc.Name,
                    rc.ColumnSchemaName,
                    rc.ColumnAttributeType,
                    rc.ColumnIsPrimaryIdAttribute,
                    rc.ColumnIsPrimaryNameAttribute,
                    rc.ColumnRequiredLevel,
            ...
            var relationshipColumsValues = $.map($("#" + domRelationshipDropdown.Id + " option"), function (option) {
                return option.value;
            });
            var alreadySelectedColumns = [];
            relationshipColumsValues.forEach(function (relationshipColumsValue) {
                if (relationshipColumsValue.indexOf(selectedRelationship.SchemaName + "|") === 0) {
                    alreadySelectedColumns.push(relationshipColumsValue);
                }
            });
...
DRB.Logic.BindSelectRelationshipColumns = function (id, relationshipType, relationshipMetadata) {
    $("#" + id).on("change", function (e) {
        ...
        if (DRB.Utilities.HasValue(selectedRelationshipValue)) {
            ...
            var fullRelationshipColumns = $.map($("#" + DRB.DOM.Relationship[relationshipType].Dropdown.Id + " option"), function (option) {
                return option.value;
            });

            // we add the other relationship columns except the current one
            fullRelationshipColumns.forEach(function (fullOneToManyColumn) {
                if (fullOneToManyColumn.indexOf(selectedRelationshipValue + "|") !== 0) {
                    newRelationshipColumns.push(fullOneToManyColumn);
                }
            });

            // we add to the new columns list the selected one
            selectedColumnsValue.forEach(function (selectedColumnValue) {
                newRelationshipColumns.push(selectedColumnValue);
            });
            ...
            var refreshedRelationshipColumns = $.map($("#" + DRB.DOM.Relationship[relationshipType].Dropdown.Id + " option"), function (option) {
                return option.value;
            });
            ...
            switch (relationshipType) {
                case "OneToMany":
                    DRB.Metadata.CurrentNode.data.configuration.oneToMany = parsedResult;
                    break;
                case "ManyToOne":
                    DRB.Metadata.CurrentNode.data.configuration.manyToOne = parsedResult;
                    break;
                case "ManyToMany":
                    DRB.Metadata.CurrentNode.data.configuration.manyToMany = parsedResult;
                    break;
            }
        }
    });
...
DRB.Logic.ClickSelectRelationshipColumns = function (relationshipType) {
    ...
    switch (relationshipType) {
        case "OneToMany":
            relationshipMetadata = DRB.Metadata.CurrentOneToMany;
            break;
        case "ManyToOne":
            relationshipMetadata = DRB.Metadata.CurrentManyToOne;
            break;
        case "ManyToMany":
            relationshipMetadata = DRB.Metadata.CurrentManyToMany;
            break;
    }
    ...
    var currentRelationshipValues = $.map($("#" + DRB.DOM.Relationship[relationshipType].Dropdown.Id + " option"), function (option) {
        return option.value;
    });
    ...
    currentRelationshipValues.forEach(function (currentRelationshipValue) {
        ...
        if (relationshipSplit.length === 2) {
            currentRelationshipNames.push(relationshipSplit[0]);
        }
    });
    ...
    if (currentRelationshipNames.length > 0) {
        var relationshipOptions = $.map($("#" + selectDOM.Relationship.Dropdown.Id + " option"), function (option) {
            return option;
        });
        relationshipOptions.forEach(function (relationshipOption) {
            if (currentRelationshipNames.indexOf(relationshipOption.value) > -1) {
                relationshipOption.style = "font-weight: bold;";
            }
        });
...
DRB.GenerateCode.SetCodeEditors = function (codeXrmWebApi, codeXrmWebApiExecute, codejQuery, codeXMLHttpRequest, codePortals) {
    ...
    if (!DRB.Utilities.HasValue(codeXrmWebApiExecute)) {
        codeXrmWebApiExecute = [];
    } // Xrm.WebApi execute is available only for Retrieve Single, Create, Update, Delete
    if (!DRB.Utilities.HasValue(codejQuery)) {
        codejQuery = [];
    }
...
DRB.GenerateCode.GetUrlFields = function (settings) {
    var urlFields = "";
    // main fields
    var fieldLogicalNames = settings.fields.map(function (field) {
        return field.oDataName;
    });
    if (settings.fields.length > 0) {
        urlFields = "$select=" + fieldLogicalNames.join();
    }
    ...
    settings.oneToMany.forEach(function (oneToMany) {
        var relFieldLogicalNames = oneToMany.fields.map(function (field) {
            return field.oDataName;
        });
    ...
    settings.manyToOne.forEach(function (ManyToOne) {
        var relFieldLogicalNames = ManyToOne.fields.map(function (field) {
            return field.oDataName;
        });
    ...
    settings.manyToMany.forEach(function (ManyToMany) {
        var relFieldLogicalNames = ManyToMany.fields.map(function (field) {
            return field.oDataName;
        });
    ...
    if (urlFields !== "") {
        urlFields = "?" + urlFields;
        if (urlFields.slice(-1) === ",") {
            urlFields = urlFields.slice(0, -1);
        }
    }
    return urlFields;
};
...
DRB.GenerateCode.GetFunctionUrl = function (settings) {
    ...
    settings.dataverseParameters.forEach(function (parameter, parameterIndex) {
        if (parameter.include === true) {
            if (parameterIndex === 0) {
                if (parameter.name === "entity" || parameter.name === "entityset") {
                    return;
                }
            }
                ...
                if (typeFound === false && parameter.type.indexOf("Collection(") === 0) {
                    ...
                    if (checkOtherParameterTypes === true) {
                        switch (parameter.type) {
                            ...
                            case "Collection(Edm.String)":
                                typeFound = true;
                                parameter.value.forEach(function (v) {
                                    printedArray += encodeURIComponent('"' + v + '"') + ", ";
                                });
                                break;
                    ...
                    if (typeFound === true) {
                        if (parameter.value.length > 0) {
                            printedArray = printedArray.slice(0, -2);
                        }
                ...
                if (typeFound === false && parameter.type.indexOf("Edm.") === 0) {
                    switch (parameter.type) {
                        ...
                        case "Edm.DateTimeOffset":
                            if (DRB.Utilities.HasValue(parameter.value)) {
                                value = new Date(parameter.value).toISOString();
                            }
                            break;
                    }
                }
...
DRB.GenerateCode.ParseFilterCriteria = function (query, configurationObject) {
    ...
    if (!configurationObject.hasOwnProperty("filterType")) {
        return "";
    }
    if (configurationObject.filterType !== "fields" && configurationObject.filterType !== "groups") {
        return "";
    }
    ...
    if (configurationObject.filterType === "fields") {
        ...
        if (configurationObject.hasOwnProperty("filterFieldsLogic")) {
            filterFieldsLogic = configurationObject.filterFieldsLogic;
        }
                            ...
                            case "DoesNotContainValues": // Microsoft.Dynamics.CRM.DoesNotContainValues(PropertyName='sample_choices',PropertyValues=['1','2'])
                                ...
                                if (Array.isArray(filterField.value)) {
                                    ...
                                    if (filterField.value.length > 0) {
                                        clearedValue = clearedValue.slice(0, -1);
                                    }
                                }
        ...
        if (partialQuery !== "") {
            partialQuery = partialQuery.substring((" " + filterFieldsLogic + " ").length);
        }
        query += partialQuery;
        return query;
    }
    ...
    if (configurationObject.filterType === "groups") {
        ...
        if (configurationObject.hasOwnProperty("filterGroupsLogic")) {
            filterGroupsLogic = configurationObject.filterGroupsLogic;
        }
...
DRB.GenerateCode.GetFilterFields = function (settings) {
    ...
    if (filterFields !== "") {
        ...
        if (filterFields.indexOf(" or ") === 0) {
            filterFields = filterFields.substring(4);
        } // remove wrong initial " or "
        if (filterFields.indexOf(" and ") === 0) {
            filterFields = filterFields.substring(5);
        } // remove wrong initial " and "

        // check final " or "
        if (filterFields.length > 3) {
            var finalString = filterFields.substring(filterFields.length - 4);
            if (finalString === " or ") {
                filterFields = filterFields.substring(0, filterFields.length - 4);
            }
        }
        // check final " and "
        if (filterFields.length > 4) {
            ...
            if (finalString === " and ") {
                filterFields = filterFields.substring(0, filterFields.length - 5);
            }
        }
    }
...
DRB.GenerateCode.GetOrderFields = function (settings) {
    ...
    if (orderFields !== "") {
        ...
        if (orderFields.slice(-1) === ",") {
            orderFields = orderFields.slice(0, -1);
        }
    }
    return orderFields;
};
            ...
            switch (field.type) {
                ...
                case "Lookup":
                    if (DRB.Utilities.HasValue(field.value.id)) {
                        criteria += field.oDataName + "=" + field.value.id + ",";
                    } else {
                        criteria += field.oDataName + "=null,";
                    }
                    break;
            }
        }
...
DRB.GenerateCode.ConvertFieldType = function (fieldType) {
    ...
    switch (fieldType) {
        case "Uniqueidentifier":
            renamedFieldType = "Guid";
            break;
        case "Picklist":
            renamedFieldType = "Choice";
            break;
        case "MultiPicklist":
            renamedFieldType = "Choices";
            break;
        case "DateTime":
            renamedFieldType = "Date Time";
            break;
        case "Double":
            renamedFieldType = "Float";
            break;
        case "Integer":
            renamedFieldType = "Whole Number";
            break;
        case "Memo":
            renamedFieldType = "Multiline Text";
            break;
        case "String":
            renamedFieldType = "Text";
            break;
        case "Money":
            renamedFieldType = "Currency";
            break;
        case "BigInt":
            renamedFieldType = "Big Integer";
            break;
    }
...
DRB.GenerateCode.GetCodeFields = function (settings) {
    ...
    if (fieldLogicalNames.indexOf(settings.primaryIdField) === -1) {
        mainFields.unshift({ logicalName: settings.primaryIdField, oDataName: settings.primaryIdField, type: "Uniqueidentifier" });
    }
    ...
    settings.oneToMany.forEach(function (oneToMany) {
        ...
        oneToMany.fields.forEach(function (field) {
            ...
            if (formattedTypes.indexOf(field.type) > -1) {
                codeFieldsFormatted.push(
                    "\tvar " + oneToMany.schemaName + "_" + field.logicalName + "_formatted = result." + oneToMany.schemaName + '[i]["' + field.oDataName + '@OData.Community.Display.V1.FormattedValue"];',
                );
            }
            if (logicalNameTypes.indexOf(field.type) > -1) {
                codeFieldsFormatted.push(
                    "\tvar " + oneToMany.schemaName + "_" + field.logicalName + "_lookuplogicalname = result." + oneToMany.schemaName + '[i]["' + field.oDataName + '@Microsoft.Dynamics.CRM.lookuplogicalname"];',
                );
            }
        });
        codeFields.push("}");
    ...
    settings.manyToOne.forEach(function (manyToOne) {
        ...
        manyToOne.fields.forEach(function (field) {
            ...
            if (formattedTypes.indexOf(field.type) > -1) {
                codeFieldsFormatted.push(
                    "\tvar " + manyToOne.navigationProperty + "_" + field.logicalName + '_formatted = result["' + manyToOne.navigationProperty + '"]["' + field.oDataName + '@OData.Community.Display.V1.FormattedValue"];',
                );
            }
            if (logicalNameTypes.indexOf(field.type) > -1) {
                codeFieldsFormatted.push(
                    "\tvar " +
                        manyToOne.navigationProperty +
                        "_" +
                        field.logicalName +
                        '_lookuplogicalname = result["' +
                        manyToOne.navigationProperty +
                        '"]["' +
                        field.oDataName +
    ...
    settings.manyToMany.forEach(function (ManyToMany) {
        ...
        ManyToMany.fields.forEach(function (field) {
            ...
            if (formattedTypes.indexOf(field.type) > -1) {
                codeFieldsFormatted.push(
                    "\tvar " + ManyToMany.schemaName + "_" + field.logicalName + "_formatted = result." + ManyToMany.schemaName + '[i]["' + field.oDataName + '@OData.Community.Display.V1.FormattedValue"];',
                );
            }
            if (logicalNameTypes.indexOf(field.type) > -1) {
                codeFieldsFormatted.push(
                    "\tvar " + ManyToMany.schemaName + "_" + field.logicalName + "_lookuplogicalname = result." + ManyToMany.schemaName + '[i]["' + field.oDataName + '@Microsoft.Dynamics.CRM.lookuplogicalname"];',
                );
            }
        });
        codeFields.push("}");
...
DRB.GenerateCode.GetXrmWebApiDefinitionParameters = function (settings, isBound, isCollectionBound, xrmWebApiAddedParameters) {
    ...
    if (isBound === true) {
        if (isCollectionBound === true) {
            definitionParameters.push('\t\t\tboundParameter: "entityset",');
        } else {
            definitionParameters.push('\t\t\tboundParameter: "entity",');
        }
    } else {
        definitionParameters.push("\t\t\tboundParameter: null,");
    }
        ...
        settings.dataverseParameters.forEach(function (parameter, parameterIndex) {
            if (parameter.include === true) {
                if (parameterIndex === 0 && parameter.name === "entityset") {
                    ...
                    if (parameter.type.indexOf("Edm.") === 0) {
                        structuralProperty = 1;
                    } // 1: PrimitiveType
                    if (parameter.type.indexOf("Collection(") === 0) {
                        ...
                        if (DRB.Utilities.HasValue(parameter.value) && DRB.Utilities.HasValue(parameter.value.members)) {
                            ...
                            definitionParameters.push(
                                "\t\t\t\t" +
                                    ...
                                    structuralProperty +
                                    ', enumProperties: [{name: "' +
                                    calculatedMemberName.join(",") +
                                    '", value: ' +
                                    calculatedMemberValue +
                                    "}] },",
                            );
                        }
                    }
...
DRB.GenerateCode.GetCodeParameters = function (settings, xrmWebApiStyle) {
    ...
    var isBound = false;
    if (settings.primaryEntity.logicalName !== "none") {
        isBound = true;
    }
    ...
    settings.dataverseParameters.forEach(function (parameter, parameterIndex) {
        if (xrmWebApiStyle !== true && isBound === true && parameterIndex === 0) {
            return;
        } // skip the first parameter if is not for Xrm.WebApi and the request is bound

        if (xrmWebApiStyle === true && isBound === true && parameterIndex === 0) {
            // first parameter bounded requires different syntax
            if (parameter.name === "entity") {
                var clearedValue = "";
                if (DRB.Utilities.HasValue(parameter.value) && DRB.Utilities.HasValue(parameter.value.id)) {
                    clearedValue = parameter.value.id;
                }
    ...
    if (xrmWebApiStyle === true) {
        if (codeParameters.length > 0) {
            codeParameters.unshift(prefix + "// Parameters");
            codeParameters.push("");
        }
    } else {
        codeParameters.push("");
    ...
    settings.setFields.forEach(function (field) {
        ...
        switch (field.type) {
            ...
            case "Memo":
                ...
                if (!DRB.Utilities.HasValue(clearedValue)) {
                    codeEntity.push("record." + field.logicalName + " = null; // " + renamedFieldType);
                } else {
            ...
            case "DateTime":
                ...
                if (!DRB.Utilities.HasValue(clearedValue)) {
                    ...
                    if (field.dateTimeBehavior === "DateOnly") {
                        ...
                        codeEntity.push("record." + field.logicalName + ' = new Date("' + clearedValue + '").toISOString(); // ' + renamedFieldType);
                    }
                }
                break;
            case "Image":
...
DRB.GenerateCode.GetXrmWebApiWarnings = function (settings, includeExpandWarning) {
    ...
    if (settings.hasOwnProperty("async") && settings.async === false) {
        warnings.push("// WARNING: Xrm.WebApi doesn't support Synchronous mode");
    }
    if (settings.hasOwnProperty("tokenHeader") && settings.tokenHeader === true) {
        warnings.push("// WARNING: Xrm.WebApi doesn't support Token Header");
    }
    if (settings.hasOwnProperty("impersonate") && settings.impersonate === true) {
        warnings.push("// WARNING: Xrm.WebApi doesn't support Impersonation");
    }
    if (settings.hasOwnProperty("formattedValues") && settings.formattedValues === false) {
        warnings.push("// WARNING: Xrm.WebApi always returns Formatted Values");
    }
    if (settings.hasOwnProperty("detectChanges") && settings.detectChanges === true) {
        warnings.push("// WARNING: Xrm.WebApi doesn't support Detect Changes");
    }
    if (settings.hasOwnProperty("retrieveCount") && settings.retrieveCount === true) {
        warnings.push("// WARNING: Xrm.WebApi doesn't support Retrieve Count");
    }
    if (settings.hasOwnProperty("returnRecord") && settings.returnRecord === true) {
        warnings.push("// WARNING: Xrm.WebApi doesn't support Return Record");
    }
    if (settings.hasOwnProperty("detectDuplicates") && settings.detectDuplicates === true) {
        warnings.push("// WARNING: Xrm.WebApi doesn't support Detect Duplicates");
    }
    if (settings.hasOwnProperty("prevent") && settings.prevent !== "none") {
        warnings.push("// WARNING: Xrm.WebApi doesn't support Prevent");
    }
    if (settings.hasOwnProperty("useAlternateKey") && settings.useAlternateKey === true) {
        warnings.push("// WARNING: Xrm.WebApi doesn't support Alternate Key");
    }
    if (includeExpandWarning === true) {
        warnings.push("// WARNING: Xrm.WebApi.online.execute doesn't support $expand");
    }
...
DRB.GenerateCode.GetPortalsWarnings = function (settings) {
    ...
    if (settings.hasOwnProperty("async") && settings.async === false) {
        warnings.push("// WARNING: Portals doesn't support Synchronous mode");
    }
    if (settings.hasOwnProperty("tokenHeader") && settings.tokenHeader === true) {
        warnings.push("// WARNING: Portals doesn't support Token Header");
    }
    if (settings.hasOwnProperty("impersonate") && settings.impersonate === true) {
        warnings.push("// WARNING: Portals doesn't support Impersonation");
    }
    if (settings.hasOwnProperty("formattedValues") && settings.formattedValues === true) {
        warnings.push("// WARNING: Portals doesn't support Formatted Values");
    }
    if (settings.hasOwnProperty("detectChanges") && settings.detectChanges === true) {
        warnings.push("// WARNING: Portals doesn't support Detect Changes");
    }
    if (settings.hasOwnProperty("returnRecord") && settings.returnRecord === true) {
        warnings.push("// WARNING: Portals doesn't support Return Record");
    }
    if (settings.hasOwnProperty("detectDuplicates") && settings.detectDuplicates === true) {
        warnings.push("// WARNING: Portals doesn't support Detect Duplicates");
    }
    if (settings.hasOwnProperty("prevent") && settings.prevent !== "none") {
        warnings.push("// WARNING: Portals doesn't support Prevent");
    }
...
DRB.GenerateCode.GetReturnType = function (settings) {
    ...
    if (settings.dataverseReturnType === null) {
        returnType.push("// No Return Type");
    } else {
...
DRB.GenerateCode.RetrieveSingle = function () {
    ...
    if (settings.useAlternateKey === true) {
        entityCriteria = DRB.GenerateCode.GetAlternateKeys(settings);
    }
    ...
    if (settings.useAlternateKey === true) {
        entityCriteriaXrmWebApi = "";
    }
    var urlFieldsXrmWebApi = urlFields;
    if (urlFields !== "") {
        urlFieldsXrmWebApi = ', "' + urlFields + '"';
    }
    ...
    codeFieldsFormatted.forEach(function (codeField) {
        codeFieldsXrmWebApi.push("\t\t" + codeField);
    });
    ...
    if (settings.fields.length > 0) {
        settings.fields.forEach(function (field) {
            executeColumns += '"' + field.logicalName + '", ';
        });
    ...
    codeFieldsFormattedOnlyRecord.forEach(function (codeField) {
        codeFieldsXrmWebApiExecute.push("\t" + codeField);
    });
    ...
    codeFields.forEach(function (codeField) {
        codeFieldsPortals.push("\t\t" + codeField);
    });
...
DRB.GenerateCode.RetrieveMultiple = function () {
    ...
    if (DRB.Utilities.HasValue(settings.topCount)) {
        codejQuery.push('\t\tvar odata_nextlink = results["@odata.nextLink"];');
    }
    ...
    if (DRB.Utilities.HasValue(settings.topCount)) {
        codeXMLHttpRequest.push('\t\t\tvar odata_nextlink = results["@odata.nextLink"];');
    }
    ...
    if (settings.retrieveCount === true) {
        codePortals.push('\t\tvar odata_count = results["@odata.count"];');
    }
...
DRB.GenerateCode.Associate = function () {
    ...
    if (!DRB.Utilities.HasValue(settings.primaryEntity) || !DRB.Utilities.HasValue(settings.secondaryEntity)) {
        ...
        var errorMessage = "";
        if (!DRB.Utilities.HasValue(settings.primaryEntity)) {
            errorMessage = "// Select a Parent Table first";
        } else {
            errorMessage = "// Select a Child Table first";
        }
    ...
    codePortals = DRB.GenerateCode.GetPortalsWarnings(settings);
    portalsCodeAssociated.forEach(function (associated) {
        codePortals.push(associated);
    });
    codePortals.push("");
    codePortals.push("webapi.safeAjax({");
    codePortals.push('\ttype: "POST",');
...
DRB.GenerateCode.RetrieveNextLink = function () {
    ...
    if (settings.retrieveCount === true) {
        codejQuery.push(codejQueryIndent + 'var odata_count = results["@odata.count"];');
    }
    if (settings.detectChanges === true) {
        codejQuery.push("\t\t}");
    }
...
DRB.GenerateCode.PredefinedQuery = function () {
    ...
    if (!DRB.Utilities.HasValue(settings.primaryEntity) || !DRB.Utilities.HasValue(settings.queryType)) {
        ...
        if (!DRB.Utilities.HasValue(settings.primaryEntity)) {
            ...
            errorMessage = "// Select a Query Type first";
        }
    ...
    switch (settings.queryType) {
        case "savedquery":
            queryParameter = "?savedQuery=" + settings.systemViewId;
            break;
        case "userquery":
            queryParameter = "?userQuery=" + settings.personalViewId;
            break;
        case "fetchxml":
    ...
    if (settings.queryType === "fetchxml") {
        codeFetchXML.forEach(function (lineFetchXML) {
            codeXrmWebApi.push(lineFetchXML);
        });
        codeXrmWebApi.push("");
    }
    if (settings.queryType !== "fetchxml") {
    ...
    if (settings.queryType === "fetchxml") {
        codeFetchXML.forEach(function (lineFetchXML) {
            codeXMLHttpRequest.push(lineFetchXML);
        });
        codeXMLHttpRequest.push("");
    }
    codeXMLHttpRequest.push("var req = new XMLHttpRequest();");
...
DRB.GenerateCode.DataverseExecute = function (requestType) {
        ...
        if (DRB.Utilities.HasValue(settings.primaryEntity) && !DRB.Utilities.HasValue(settings.dataverseExecute)) {
            switch (requestType) {
                case "executecustomapi":
                    errorMessage = "// Select a Custom API first";
                    break;
                case "executecustomaction":
                    errorMessage = "// Select a Custom Action first";
                    break;
                case "executeaction":
                    errorMessage = "// Select an Action first";
                    break;
                case "executefunction":
                    errorMessage = "// Select a Function first";
                    break;
            }
        }
        codeXrmWebApi.push(errorMessage);
    ...
    if (isBound === true && settings.dataverseParameters.length > 0 && settings.dataverseParameters[0].name === "entityset") {
        isCollectionBound = true;
    }
    ...
    for (var i = 0; i < settings.dataverseParameters.length; i++) {
        if (settings.dataverseParameters[i].include === true) {
            xrmWebApiAddedParameters = true;
            break;
        }
    }
    if (isBound === false) {
        xhrAddedParameters = xrmWebApiAddedParameters;
    } else {
        for (var i = 1; i < settings.dataverseParameters.length; i++) {
            if (settings.dataverseParameters[i].include === true) {
                xhrAddedParameters = true;
                break;
            }
        }
    }
    ...
    if (isBound === true) {
        if (isCollectionBound === false) {
            var primaryId = "";
            if (DRB.Utilities.HasValue(settings.dataverseParameters[0].value.id)) {
                primaryId = settings.dataverseParameters[0].value.id;
            }
            mainUrl += settings.primaryEntity.entitySetName + "(" + primaryId + ")/Microsoft.Dynamics.CRM." + settings.dataverseExecute;
        } else {
            mainUrl += settings.primaryEntity.entitySetName + "/Microsoft.Dynamics.CRM." + settings.dataverseExecute;
        }
    } else {
        mainUrl += settings.dataverseExecute;
    }
    ...
    definitionParameters.forEach(function (line) {
        codeXrmWebApi.push(line);
    });
...
DRB.GenerateCode.PowerAutomate = function (requestType) {
    if (requestType !== "retrievesingle" && requestType !== "retrievemultiple") {
        return;
    }
    ...
    switch (requestType) {
        ...
        case "retrievemultiple":
            $("#" + pa_editor).append(
                DRB.UI.CreateSpan(DRB.DOM.PowerAutomate.SpanTitleRetrieveMultiple.Id, DRB.DOM.PowerAutomate.SpanTitleRetrieveMultiple.Name, null, DRB.DOM.PowerAutomate.SpanTitleRetrieveMultiple.Class),
            );
            break;
    }
    ...
    switch (requestType) {
        case "retrievesingle":
            paSettings = ["TableName", "RowID", "SelectColumns", "ExpandQuery"];
            break;
        case "retrievemultiple":
            paSettings = ["TableName", "SelectColumns", "FilterRows", "SortBy", "ExpandQuery", "RowCount"];
            break;
    }
    ...
    paSettings.forEach(function (setting, settingIndex) {
        ...
        if (settingIndex > 0) {
            tdCopy.append(
                DRB.UI.CreateButton(
                    DRB.DOM.PowerAutomate.ButtonCopy.Id + DRB.DOM.PowerAutomate[setting + "Span"].Id,
                    DRB.DOM.PowerAutomate.ButtonCopy.Name,
                    DRB.DOM.PowerAutomate.ButtonCopy.Class,
                    DRB.Logic.CopyCodeForPowerautomate,
                    setting,
                    DRB.DOM.PowerAutomate[setting + "Span"].Name,
                ),
            );
        }
    });
    ...
    if (settings.fields.length > 0) {
        selectColumns = fieldLogicalNames.join();
    }
    ...
    if (settings.oneToMany.length > 0 || settings.manyToOne.length > 0 || settings.manyToMany.length > 0) {
        ...
        if (expandQuery.slice(-1) === ",") {
            expandQuery = expandQuery.slice(0, -1);
        }
    }
    // #endregion
    ...
    switch (requestType) {
        ...
        case "retrievemultiple":
            var rowCount = "";
            if (DRB.Utilities.HasValue(settings.topCount)) {
                rowCount = settings.topCount;
            }
            var filterRows = DRB.GenerateCode.GetFilterFields(settings);
            if (DRB.Utilities.HasValue(filterRows)) {
                filterRows = filterRows.replace("$filter=", "");
            }
            var sortBy = DRB.GenerateCode.GetOrderFields(settings);
            if (DRB.Utilities.HasValue(sortBy)) {
                sortBy = sortBy.replace("$orderby=", "");
            }
            $("#" + DRB.DOM.PowerAutomate.TableNameInput.Id).val(tableName);
            $("#" + DRB.DOM.PowerAutomate.SelectColumnsInput.Id).val(selectColumns);
...
DRB.GenerateCode.Start = function () {
    ...
    switch (requestType) {
        case "retrievesingle":
            DRB.GenerateCode.RetrieveSingle();
            break;
        case "retrievemultiple":
            DRB.GenerateCode.RetrieveMultiple();
            break;
        case "create":
            DRB.GenerateCode.Create();
            break;
        case "update":
            DRB.GenerateCode.Update();
            break;
        case "delete":
            DRB.GenerateCode.Delete();
            break;
        case "associate":
            DRB.GenerateCode.Associate();
            break;
        case "disassociate":
            DRB.GenerateCode.Disassociate();
            break;
        case "retrievenextlink":
            DRB.GenerateCode.RetrieveNextLink();
            break;
        case "predefinedquery":
            DRB.GenerateCode.PredefinedQuery();
            break;
...
DRB.GeneratePostman.GetUpsertBody = function (settings) {
    ...
    settings.setFields.forEach(function (field) {
        switch (field.type) {
            ...
            case "Memo":
                ...
                if (!DRB.Utilities.HasValue(clearedValue)) {
                    upsertBody.push('\t"' + field.logicalName + '": null,');
                } else {
    ...
    if (upsertBody.length > 0) {
        ...
        if (lastComma > -1) {
            upsertBody[upsertBody.length - 1] = upsertBody[upsertBody.length - 1].slice(0, lastComma);
        }
    }
    upsertBody.unshift("{");
    upsertBody.push("}");
...
DRB.GeneratePostman.GetExecuteParameters = function (settings) {
    ...
    settings.dataverseParameters.forEach(function (parameter, parameterIndex) {
        if (isBound === true && parameterIndex === 0) {
            return;
        } // skip the first parameter if the request is bound
    ...
    if (executeParameters.length > 0) {
        ...
        if (lastComma > -1) {
            executeParameters[executeParameters.length - 1] = executeParameters[executeParameters.length - 1].slice(0, lastComma);
        }
    }
...
DRB.GeneratePostman.Start = function (requestType, settings) {
    switch (requestType) {
        case "retrievesingle":
            return DRB.GeneratePostman.RetrieveSingle(settings);
            break;
        case "retrievemultiple":
            return DRB.GeneratePostman.RetrieveMultiple(settings);
            break;
        case "create":
            return DRB.GeneratePostman.Create(settings);
            break;
        case "update":
            return DRB.GeneratePostman.Update(settings);
            break;
        case "delete":
            return DRB.GeneratePostman.Delete(settings);
            break;
        case "associate":
            return DRB.GeneratePostman.Associate(settings);
            break;
        case "disassociate":
            return DRB.GeneratePostman.Disassociate(settings);
            break;
        case "retrievenextlink":
            return DRB.GeneratePostman.RetrieveNextLink(settings);
            break;
        case "predefinedquery":
            return DRB.GeneratePostman.PredefinedQuery(settings);
            break;
        case "executeworkflow":
...
DRB.CustomUI.AddVersion = function () {
    ...
    if (DRB.Utilities.HasValue(versionExists)) {
        selectedVersion = versionExists.Id;
    }
    $("#" + DRB.DOM.Version.Dropdown.Id)
        .val(selectedVersion)
        .change();
};
...
DRB.CustomUI.AddProcess = function () {
    ...
    if (DRB.Metadata.CurrentNode.data.configuration.async === false) {
        processValue = "no";
    }
    $("#" + DRB.DOM.Process.Dropdown.Id)
        .val(processValue)
        .change();
};
...
DRB.CustomUI.AddTokenHeader = function () {
    ...
    if (DRB.Metadata.CurrentNode.data.configuration.tokenHeader === true) {
        tokenHeaderValue = "yes";
    }
    $("#" + DRB.DOM.TokenHeader.Dropdown.Id)
        .val(tokenHeaderValue)
        .change();
};
...
DRB.CustomUI.AddImpersonate = function () {
    ...
    if (DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.configuration.impersonateId)) {
        $("#" + DRB.DOM.ImpersonateId.Input.Id)
            .val(DRB.Metadata.CurrentNode.data.configuration.impersonateId)
            .trigger("input");
    }
};
...
DRB.CustomUI.AddFormattedValues = function () {
    ...
    if (DRB.Metadata.CurrentNode.data.configuration.formattedValues === false) {
        formattedValuesValue = "no";
    }
    $("#" + DRB.DOM.FormattedValues.Dropdown.Id)
        .val(formattedValuesValue)
        .change();
};
...
DRB.CustomUI.AddDetectChanges = function () {
    ...
    if (DRB.Metadata.CurrentNode.data.configuration.detectChanges === true) {
        detectChangesValue = "yes";
    }
    $("#" + DRB.DOM.DetectChanges.Dropdown.Id)
        .val(detectChangesValue)
        .change();
};
...
DRB.CustomUI.AddDetectDuplicates = function () {
    ...
    if (DRB.Metadata.CurrentNode.data.configuration.detectDuplicates === true) {
        detectDuplicatesValue = "yes";
    }
    $("#" + DRB.DOM.DetectDuplicates.Dropdown.Id)
        .val(detectDuplicatesValue)
        .change();
};
...
DRB.CustomUI.AddRetrieveCount = function () {
    ...
    if (DRB.Metadata.CurrentNode.data.configuration.retrieveCount === true) {
        retrieveCountValue = "yes";
    }
    $("#" + DRB.DOM.RetrieveCount.Dropdown.Id)
        .val(retrieveCountValue)
        .change();
};
...
DRB.CustomUI.AddPrevent = function () {
    ...
    if (DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.configuration.prevent)) {
        preventValue = DRB.Metadata.CurrentNode.data.configuration.prevent;
    }
    $("#" + DRB.DOM.Prevent.Dropdown.Id)
        .val(preventValue)
        .change();
};
...
DRB.CustomUI.AddTopCount = function () {
    ...
    var topCountValue = "";
    if (DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.configuration.topCount)) {
        topCountValue = DRB.Metadata.CurrentNode.data.configuration.topCount;
    }
    $("#" + DRB.DOM.TopCount.Input.Id)
        .val(topCountValue)
        .change();
};
...
DRB.CustomUI.AddUseAlternateKey = function () {
    ...
    if (DRB.Metadata.CurrentNode.data.configuration.useAlternateKey === true) {
        useAlternateKeyValue = "yes";
    }
    if (useAlternateKeyValue === "no") {
        $("#" + DRB.DOM.UseAlternateKey.Dropdown.Id)
            .val(useAlternateKeyValue)
            .change();
    }
};
...
DRB.CustomUI.AddPrimaryId = function (hide, container) {
    if (!DRB.Utilities.HasValue(container)) {
        container = DRB.DOM.ConfigureContent.Id;
    }
...
DRB.CustomUI.AddWorkflowId = function () {
    ...
    if (DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.configuration.workflowId)) {
        $("#" + DRB.DOM.WorkflowId.Input.Id)
            .val(DRB.Metadata.CurrentNode.data.configuration.workflowId)
            .trigger("input");
    }
};
...
DRB.CustomUI.AddTypeColumns = function (container, columnType, domObject, metadataPath) {
    ...
    // "Add" button
    $("#" + DRB.DOM[domObject].MainDiv.Id + metadataPath).append(
        DRB.UI.CreateButton(DRB.DOM[domObject].AddButton.Id + metadataPath, DRB.DOM[domObject].AddButton.Name, DRB.DOM[domObject].AddButton.Class, DRB.Logic.AddColumn, columnType, domObject, metadataPath),
    );
                ...
                setTimeout(function () {
                    ...
                    DRB.Common.RetrieveTablesDetails([tableLogicalName], true, true)
                        .done(function () {
                            ...
                            table.OneToManyRelationships.forEach(function (relationship) {
                                tableLogicalNames.push(relationship.SourceTable);
                                tableLogicalNames.push(relationship.TargetTable);
                            });
                            table.ManyToOneRelationships.forEach(function (relationship) {
                                tableLogicalNames.push(relationship.SourceTable);
                                tableLogicalNames.push(relationship.TargetTable);
                            });
                            table.ManyToManyRelationships.forEach(function (relationship) {
                                tableLogicalNames.push(relationship.SourceTable);
                                tableLogicalNames.push(relationship.TargetTable);
                            });
                            ...
                            tableLogicalNames.forEach(function (checkTableLogicalName) {
                                ...
                                if (DRB.Utilities.HasValue(checkTable) && checkTable.ColumnsLoaded === false) {
...
DRB.Logic.MoveColumn = function (index, direction, domObject, metadataPath) {
    ...
    if (refMetadata[positionToCheck].Id != index) {
        ...
        var posIndex = -1;
        for (var count = countStart; count < countEnd; count++) {
            if (refMetadata[count].Id == index) {
                posIndex = count;
                break;
            }
        }
        ...
        // swap tr
        if (direction === "down") {
            $("#" + DRB.DOM[domObject].Tr.Id + metadataPath + "_" + index)
                .next()
                .after($("#" + DRB.DOM[domObject].Tr.Id + metadataPath + "_" + index));
        } else {
            $("#" + DRB.DOM[domObject].Tr.Id + metadataPath + "_" + index)
                .prev()
                .before($("#" + DRB.DOM[domObject].Tr.Id + metadataPath + "_" + index));
        }
...
DRB.Logic.RefreshColumns = function (columnType, domObject, metadataPath) {
    ...
    if (columnType === "IsValidForFilter") {
        if (refMetadata.length > 1) {
            ...
            $("#" + DRB.DOM[domObject].DropdownLogic.Id + metadataPath)
                .val(DRB.Settings.OptionsAndOr[0].Id)
                .change();
    ...
    refMetadata.forEach(function (metadataColumn) {
        ...
        if (columnType !== "IsValidForFilter") {
            ...
            DRB.Metadata.CurrentColumns.forEach(function (currentColumn) {
                if ((currentColumn[columnType] === true && usedColumnsNames.indexOf(currentColumn.LogicalName) === -1) || currentColumn.LogicalName === originalColumnName) {
            ...
            availableColumns = [];
            DRB.Metadata.CurrentColumns.forEach(function (currentColumn) {
                if (currentColumn[columnType] === true) {
                    availableColumns.push(currentColumn);
                }
            });
        }
...
DRB.Logic.RemoveColumn = function (index, columnType, domObject, metadataPath) {
    ...
    refMetadata.forEach(function (column, columnIndex) {
        if (column.Id == index) {
            indexToRemove = columnIndex;
        } else {
            newMetadataColumns.push(column);
        }
    });

    refMetadata.length = 0;
    newMetadataColumns.forEach(function (newMetadataColumn) {
        refMetadata.push(newMetadataColumn);
    });
    ...
    if (indexToRemove > -1) {
        ...
        newFields.forEach(function (newField) {
            refConfiguration.push(newField);
        });
    }
...
DRB.Logic.AddColumn = function (columnType, domObject, metadataPath) {
    ...
    if (refMetadata.length > 0) {
        var maxValue = 0;
        refMetadata.forEach(function (setColumn) {
            if (setColumn.Id > maxValue) {
                maxValue = setColumn.Id;
            }
        });
        index = maxValue + 1;
    }
    ...
    var tdOperator = null;
    if (columnType === "IsValidForFilter") {
        tdOperator = DRB.UI.CreateTd(DRB.DOM[domObject].TdOperator.Id + uniqueIndex);
    }
    ...
    DRB.Metadata.CurrentColumns.forEach(function (currentColumn) {
        if (currentColumn[columnType] === true) {
            columnRecords.push(currentColumn);
        }
    });
...
DRB.Logic.BindFilterColumnValue = function (id) {
    $("#" + id).on("change", function (e) {
        ...
        while (splittedControlName.length > 0 && splittedControlName[0] !== "filterCriteria") {
            splittedControlName.shift();
        }
        ...
        refMetadata.forEach(function (setColumn, columnIndex) {
            if (setColumn.Id === elementIndex) {
                ...
                if (controlName.indexOf("cbxm_") === 0) {
                    currentField.value = controlValue;
                }
...
DRB.Logic.BindFilterColumnOperator = function (id, domObject) {
    $("#" + id).on("change", function (e) {
        ...
        refMetadata.forEach(function (setColumn, columnIndex) {
            if (setColumn.Id === elementIndex) {
                DRB.Settings.OperatorsToStop.forEach(function (operatorToStop) {
                    if (operator === operatorToStop.Id) {
                        requiredValue = false;
                    }
                });
        ...
        if (DRB.Utilities.HasValue(column)) {
            ...
            if (requiredValue === true) {
                ...
                switch (column.AttributeType) {
                    ...
                    case "String":
                        divValue.append(
                            DRB.UI.CreateInputString("txt_" + DRB.DOM[domObject].ControlValue.Id + metadataPath, column.AdditionalProperties.MaxLength, "Max Length: " + column.AdditionalProperties.MaxLength),
                        );
                        DRB.Logic.BindFilterColumnValue("txt_" + DRB.DOM[domObject].ControlValue.Id + metadataPath);
                        break;
                    ...
                    case "BigInt":
                        divValue.append(
                            DRB.UI.CreateInputNumber(
                                "txt_" + DRB.DOM[domObject].ControlValue.Id + metadataPath,
                                "Min Value: " + column.AdditionalProperties.MinValue + " - Max Value: " + column.AdditionalProperties.MaxValue,
                            ),
                        );
                    ...
                    case "Customer":
                        ...
                        if (column.AdditionalProperties.Targets.length > 0) {
                            ...
                            $("#cbx2_" + DRB.DOM[domObject].ControlValue.Id + metadataPath)
                                .val(targets[0].Id)
                                .change();
                        }
                        break;
...
DRB.Logic.BindFilterColumn = function (id, columnType, domObject, metadataPath) {
    $("#" + id).on("change", function (e) {
        ...
        if (DRB.Utilities.HasValue(column)) {
            ...
            switch (field.type) {
                case "Owner":
                    optionsOperator = DRB.Settings.OptionsOperatorOwner;
                    break;
                case "String":
                    optionsOperator = DRB.Settings.OptionsOperatorString;
                    break;
                case "Memo":
                    optionsOperator = DRB.Settings.OptionsOperatorMemo;
                    break;
                case "DateTime":
...
DRB.Logic.BindOrderColumn = function (id, columnType, domObject, metadataPath) {
    $("#" + id).on("change", function (e) {
        ...
        if (DRB.Utilities.HasValue(column)) {
            ...
            $("#" + currentId)
                .val(DRB.Settings.OptionsOrder[0].Id)
                .change();
        }
        DRB.Logic.RefreshColumns(columnType, domObject, metadataPath);
    });
...
DRB.Logic.RetrieveMultiple.RefreshDropdownLogic = function (logicValue, controlName, isGroupLogic) {
    ...
    if (splittedControlName.length > 0) {
        splittedControlName.pop();
    }
    ...
    if (isGroupLogic === false) {
        ...
        $("." + spanClass).each(function (i, span) {
            $(span).html(logicValue);
        });
    }
};
/**
...
DRB.Logic.RetrieveMultiple.AddFilterGroup = function (container, domObject, metadataPath) {
    ...
    if (refMetadata.length > 0) {
        var maxValue = -1;
        refMetadata.forEach(function (item) {
            if (item.Id > maxValue) {
                maxValue = item.Id;
            }
        });
    ...
    $("#" + DRB.DOM[domObject].DivChoice.Id + metadataPathIndex + "_dropdown").append(
        DRB.UI.CreateButton(DRB.DOM[domObject].ButtonChoice.Id + metadataPathIndex, DRB.DOM[domObject].ButtonChoice.Name, DRB.DOM[domObject].ButtonChoice.Class),
    );
    ...
    $("#" + DRB.DOM[domObject].DivDropdownChoice.Id + metadataPathIndex).append(
        DRB.UI.CreateButton(
            DRB.DOM[domObject].ButtonChoiceColumns.Id + metadataPathIndex,
            DRB.DOM[domObject].ButtonChoiceColumns.Name,
            DRB.DOM[domObject].ButtonChoiceColumns.Class,
            DRB.Logic.RetrieveMultiple.AddManuallyFilterColumns,
            "FilterColumns",
            metadataPathIndex,
        ),
    );
    $("#" + DRB.DOM[domObject].DivDropdownChoice.Id + metadataPathIndex).append(
        DRB.UI.CreateButton(
            DRB.DOM[domObject].ButtonChoiceGroups.Id + metadataPathIndex,
            DRB.DOM[domObject].ButtonChoiceGroups.Name,
            DRB.DOM[domObject].ButtonChoiceGroups.Class,
            DRB.Logic.RetrieveMultiple.AddManuallyFilterGroups,
            "FilterGroups",
            metadataPathIndex,
        ),
    );
...
DRB.Logic.RetrieveMultiple.RemoveFilterGroup = function (domObject, metadataPath) {
    ...
    for (var i = 0; i < refMetadata.length; i++) {
        if (refMetadata[i].Id === indexToRemove) {
            ...
            if (i > 0) {
                ...
                $("#" + DRB.DOM[domObject].MainDiv.Id + metadataPath)
                    .prev()
                    .remove();
            } else {
    ...
    if (refMetadata.length < 2) {
        ...
        if (refMetadata.length === 1) {
            ...
            $("#" + DRB.DOM[domObject].DropdownLogic.Id + previousMetadataPath)
                .val(DRB.Settings.OptionsAndOr[0].Id)
                .change();
        }
...
DRB.Logic.RetrieveMultiple.AddFilterGroups = function (domObject, metadataPath) {
    ...
    if (metadataPath !== "filterCriteria") {
        container = DRB.DOM[domObject].MainDiv.Id + metadataPath;
    }
    ...
    if (!refMetadata.hasOwnProperty("filterGroupsLogic")) {
        refMetadata.filterGroupsLogic = "and";
    }
    if (!refConfiguration.hasOwnProperty("filterGroupsLogic")) {
        refConfiguration.filterGroupsLogic = "and";
    }

    if (!refMetadata.hasOwnProperty("filterGroups")) {
        refMetadata.filterGroups = [];
    }
    if (!refConfiguration.hasOwnProperty("filterGroups")) {
        refConfiguration.filterGroups = [];
    }
    ...
    $("#" + DRB.DOM[domObject].DivOptions.Id + metadataPath).append(
        DRB.UI.CreateButton(
            DRB.DOM[domObject].AddButton.Id + metadataPath,
            DRB.DOM[domObject].AddButton.Name,
            DRB.DOM[domObject].AddButton.Class,
            DRB.Logic.RetrieveMultiple.AddFilterGroup,
            DRB.DOM[domObject].DivGroups.Id + metadataPath,
            domObject,
            metadataPath,
        ),
    );
    ...
    $("#" + DRB.DOM[domObject].DropdownLogic.Id + metadataPath)
        .val(refMetadata.filterGroupsLogic)
        .change();
...
DRB.Logic.RetrieveMultiple.AddFilterColumns = function (domObject, metadataPath) {
    ...
    var container = DRB.DOM.FilterBy.MainDiv.Id;
    if (metadataPath !== "filterCriteria") {
        container = DRB.DOM.FilterGroups.MainDiv.Id + metadataPath;
    } // host of a Filter Columns is the base or a group
    ...
    if (!refMetadata.hasOwnProperty("filterFieldsLogic")) {
        refMetadata.filterFieldsLogic = "and";
    }
    if (!refConfiguration.hasOwnProperty("filterFieldsLogic")) {
        refConfiguration.filterFieldsLogic = "and";
    }
    if (!refMetadata.hasOwnProperty("filterFields")) {
        refMetadata.filterFields = [];
    }
    if (!refConfiguration.hasOwnProperty("filterFields")) {
    ...
    $("#" + DRB.DOM[domObject].DropdownLogic.Id + metadataPath)
        .val(refMetadata.filterFieldsLogic)
        .change();
    $("#" + DRB.DOM[domObject].DivLogic.Id + metadataPath).hide(); // hide filter logic by default
    ...
    clearedFields.forEach(function (field, fieldIndex) {
        ...
        $("#" + DRB.DOM[domObject].Dropdown.Id + metadataPath + "_" + fieldIndex)
            .val(field.logicalName)
            .change();
        // set operator
        $("#" + DRB.DOM[domObject].ControlOperator.Id + metadataPath + "_" + fieldIndex)
            .val(field.operator)
            .change();
        // set value
        var controlPrefix = "";
        ...
        switch (field.type) {
            ...
            case "Customer":
                if (DRB.Utilities.HasValue(field.value)) {
                    $("#" + controlPrefix + DRB.DOM[domObject].ControlValue.Id + metadataPath + "_" + fieldIndex)
                        .val(field.value.id)
                        .change();
                    $("#" + controlPrefixLookup + DRB.DOM[domObject].ControlValue.Id + metadataPath + "_" + fieldIndex)
                        .val(field.value.entityType)
                        .change();
                }
                break;
...
DRB.Logic.RetrieveMultiple.RemoveFilterGroups = function (domObject, metadataPath) {
    ...
    var splittedMetadataPath = metadataPath.split("_");
    if (splittedMetadataPath.length > 0) {
        splittedMetadataPath.pop();
    }
...
DRB.Logic.RetrieveMultiple.RemoveFilterColumns = function (domObject, metadataPath) {
    ...
    if (splittedMetadataPath.length > 0) {
        splittedMetadataPath.pop();
    } // remove "filterFields" (is always the last one)
...
DRB.Logic.RetrieveMultiple.ParseFilterCriteria = function (filterCriteria, metadataPath) {
    ...
    // filterType must be "fields" or "groups", otherwise return
    if (!filterCriteria.hasOwnProperty("filterType")) {
        return;
    }
    if (filterCriteria.filterType !== "fields" && filterCriteria.filterType !== "groups") {
        return;
    }
    ...
    if (filterCriteria.filterType === "fields") {
        ...
        $("#" + DRB.DOM.FilterColumns.DropdownLogic.Id + metadataPath + "_filterFields")
            .val(refMetadata.filterFieldsLogic)
            .change();
        return;
    }
    ...
    if (filterCriteria.filterType === "groups") {
        ...
        $("#" + DRB.DOM.FilterGroups.DropdownLogic.Id + metadataPath + "_filterGroups")
            .val(refMetadata.filterGroupsLogic)
            .change();
        return;
    }
...
DRB.Logic.RetrieveMultiple.ConfigureFilterBy = function () {
    ...
    $("#" + DRB.DOM.FilterGroups.DivChoice.Id + metadataPath).append(
        DRB.UI.CreateButton(
            DRB.DOM.FilterBy.StartButton.Id,
            DRB.DOM.FilterBy.StartButton.Name,
            DRB.DOM.FilterBy.StartButton.Class,
            DRB.Logic.RetrieveMultiple.StartAddFilter,
            "FilterGroups",
            "FilterColumns",
            metadataPath,
        ),
...
DRB.Logic.RetrieveMultiple.ConfigureOrderColumns = function () {
    ...
    clearedFields.forEach(function (field, fieldIndex) {
        ...
        $("#" + DRB.DOM[domObject].Dropdown.Id + metadataPath + "_" + fieldIndex)
            .val(field.logicalName)
            .change();
        $("#cbx_" + DRB.DOM[domObject].ControlValue.Id + metadataPath + "_" + fieldIndex)
            .val(field.value)
            .change();
    });
};
                ...
                if (controlName.indexOf("cbx2_") === 0) {
                    ...
                    for (var relCount = 0; relCount < DRB.Metadata.CurrentManyToOne.length; relCount++) {
                        if (DRB.Metadata.CurrentManyToOne[relCount].NavigationAttribute === sourceColumn) {
                            if (DRB.Metadata.CurrentManyToOne[relCount].TargetTable === controlValue || DRB.Metadata.CurrentManyToOne[relCount].TargetTable === "owner") {
    ...
    $("#" + id).on("change", function (e) {
        ...
        if (DRB.Utilities.HasValue(column)) {
            ...
            switch (column.AttributeType) {
                ...
                case "BigInt":
                    divValue.append(
                        DRB.UI.CreateInputNumber("txt_" + DRB.DOM[domObject].ControlValue.Id + uniqueIndex, "Min Value: " + column.AdditionalProperties.MinValue + " - Max Value: " + column.AdditionalProperties.MaxValue),
                    );
                ...
                case "Customer":
                    ...
                    if (column.AdditionalProperties.Targets.length > 0) {
                        ...
                        divValue.append(
                            DRB.UI.CreateLookup("lkp_" + DRB.DOM[domObject].ControlValue.Id + uniqueIndex, DRB.UI.OpenLookup, {
                                openCustom: true,
                                defaultEntityType: column.AdditionalProperties.Targets[0],
                                entityTypes: column.AdditionalProperties.Targets,
                        ...
                        $("#cbx2_" + DRB.DOM[domObject].ControlValue.Id + uniqueIndex)
                            .val(targets[0].Id)
                            .change();
                    }
                    break;
                ...
                case "DateTime":
                    ...
                    divValue.append(
                        DRB.UI.CreateInputDateTime("txtd_" + DRB.DOM[domObject].ControlValue.Id + uniqueIndex, dateTimeBehavior, "Behavior: " + clearedDateTimeBehavior + " - Format: " + clearedDateTimeFormat),
                    );
                    DRB.Logic.BindSetColumnValue("txtd_" + DRB.DOM[domObject].ControlValue.Id + uniqueIndex, domObject, metadataPath);
                    $("#txtd_" + DRB.DOM[domObject].ControlValue.Id + uniqueIndex)
                        .datetimepicker({ format: pickerFormat, ignoreReadonly: true, showClear: true, showTodayButton: true })
                        .on("dp.change", function (e) {
                            $(e.target).change();
                        });
                ...
                case "Image":
                    ...
                    divValue.append(
                        DRB.UI.CreateButton(
                            DRB.DOM.Image.LoadButton.Id + DRB.DOM[domObject].ControlValue.Id + uniqueIndex,
                            DRB.DOM.Image.LoadButton.Name,
                            DRB.DOM.Image.LoadButton.Class,
                            DRB.Logic.LoadImage,
                            domObject,
                            metadataPath,
                            elementIndex,
                    ...
                    divValue.append(
                        DRB.UI.CreateButton(
                            DRB.DOM.Image.ShowButton.Id + DRB.DOM[domObject].ControlValue.Id + uniqueIndex,
                            DRB.DOM.Image.ShowButton.Name,
                            DRB.DOM.Image.ShowButton.Class,
                            DRB.Logic.ShowImage,
                            metadataPath,
                            elementIndex,
                        ),
                    ...
                    divValue.append(
                        DRB.UI.CreateButton(
                            DRB.DOM.Image.RemoveButton.Id + DRB.DOM[domObject].ControlValue.Id + uniqueIndex,
                            DRB.DOM.Image.RemoveButton.Name,
                            DRB.DOM.Image.RemoveButton.Class,
                            DRB.Logic.RemoveImage,
                            domObject,
                            metadataPath,
                            elementIndex,
                        ),
...
DRB.Logic.AfterSetTableLoaded = function (table, columnType, domObject, metadataPath) {
    ...
    if (columnType === "IsValidForUpdate") {
        DRB.Logic.FillAlternateKeys();
    }
    ...
    // show the DOM
    $("#" + DRB.DOM[domObject].MainDiv.Id + metadataPath).show();
    $("#" + DRB.DOM[domObject].Table.Id + metadataPath + " tr")
        .slice(1)
        .remove();
    ...
    clearedFields.forEach(function (field, fieldIndex) {
        ...
        $("#" + DRB.DOM[domObject].Dropdown.Id + uniqueIndex)
            .val(field.logicalName)
            .change();
        ...
        switch (field.type) {
            ...
            case "State":
            case "Status":
                $("#cbx1_" + DRB.DOM[domObject].ControlValue.Id + uniqueIndex)
                    .val(field.value)
                    .change();
            ...
            case "MultiPicklist":
                $("#cbxm_" + DRB.DOM[domObject].ControlValue.Id + uniqueIndex)
                    .val(field.value)
                    .change();
            ...
            case "Customer":
                ...
                if (DRB.Utilities.HasValue(field.value)) {
                    ...
                    entityTypeValue = field.value.entityType;
                }
                $("#txt2_" + DRB.DOM[domObject].ControlValue.Id + uniqueIndex)
                    .val(idValue)
                    .trigger("input")
                    .change();
                $("#cbx2_" + DRB.DOM[domObject].ControlValue.Id + uniqueIndex)
...
DRB.Logic.Create.Start = function () {
    ...
    if (DRB.Metadata.CurrentNode.data.configuration.returnRecord === true) {
        returnRecordValue = "yes";
    }
    // trigger later
    // #endregion
    ...
    // Return Record
    $("#" + DRB.DOM.ReturnRecord.Dropdown.Id)
        .val(returnRecordValue)
        .change();
    // #endregion
};
...
DRB.Logic.Association.RemoveChildId = function (index) {
    ...
    DRB.Metadata.SecondaryIds.forEach(function (secondaryId, secondaryIndex) {
        if (secondaryId.Id == index) {
            indexToRemove = secondaryIndex;
        } else {
            newMetadataSecondaryIds.push(secondaryId);
        }
    });
    ...
    if (indexToRemove > -1) {
        ...
        DRB.Metadata.CurrentNode.data.configuration.secondaryIds.forEach(function (secondaryId, secondaryIndex) {
            if (secondaryIndex != indexToRemove) {
                newSecondaryIds.push(secondaryId);
            }
        });
...
DRB.Logic.Association.AddChildId = function (idValue) {
    ...
    var index = 0;
    if (DRB.Metadata.SecondaryIds.length > 0) {
        index = DRB.Metadata.SecondaryIds[DRB.Metadata.SecondaryIds.length - 1].Id + 1;
    }
...
DRB.Logic.Association.AfterTableLoaded = function (table) {
    ...
    tableLogicalNames.forEach(function (tableLogicalName) {
        ...
        if (DRB.Utilities.HasValue(childTable)) {
    ...
    $("#" + DRB.DOM.ChildTable.Dropdown.Id)
        .val(childTable)
        .change();
        ...
        if (DRB.Utilities.HasValue(parentTable) && DRB.Utilities.HasValue(childTable)) {
            ...
            parentTable.OneToManyRelationships.forEach(function (relationship) {
                if (relationship.TargetTable === childTableLogicalName) {
                    relationships.push(
                        new DRB.Models.SimpleRelationship(
                            relationship.SchemaName,
                            relationship.Type,
            ...
            $("#" + DRB.DOM.ParentRelationship.Dropdown.Id)
                .val(relationship)
                .change();
...
DRB.Logic.Association.Start = function () {
    ...
    if (DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.configuration.primaryEntity)) {
        ...
        if (!DRB.Utilities.HasValue(checkTable)) {
            ...
            $("#" + DRB.DOM.ParentTable.Dropdown.Id)
                .val(DRB.Metadata.CurrentNode.data.configuration.primaryEntity.logicalName)
                .change();
        }
    }
    ...
    if (Array.isArray(DRB.Metadata.CurrentNode.data.configuration.secondaryIds)) {
        ...
        secondaryIds.forEach(function (secondaryId, secondaryIndex) {
            ...
            $("#" + DRB.DOM.ChildId.InputPrefix.Id + secondaryIndex)
                .val(secondaryId)
                .trigger("input");
        });
    }
...
DRB.Logic.RetrieveNextLink.BindNextLink = function (id) {
    $("#" + id).on("change", function (e) {
        ...
        if (parseLink.indexOf("?") > -1) {
            parseLink = parseLink.substring(0, parseLink.indexOf("?"));
        }
...
DRB.Logic.RetrieveNextLink.Start = function () {
    ...
    if (DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.configuration.nextLink)) {
        $("#" + DRB.DOM.NextLink.Input.Id)
            .val(DRB.Metadata.CurrentNode.data.configuration.nextLink)
            .change();
    }
    // #endregion
...
DRB.Logic.PredefinedQuery.AfterTableLoaded = function (table) {
    ...
    $("#" + DRB.DOM.QueryType.Dropdown.Id)
        .val(DRB.Metadata.CurrentNode.data.configuration.queryType)
        .change();
                    ...
                    DRB.Common.RetrievePersonalViews()
                        .done(function (data) {
                            ...
                            personalViews.forEach(function (personalView) {
                                ...
                                if (DRB.Utilities.HasValue(viewTable)) {
                                    viewTable.PersonalViews.push(personalView);
                                }
                            });
                            // set the personal views loaded as true for all the tables
                            DRB.Metadata.Tables.forEach(function (setTable) {
                                setTable.PersonalViewsLoaded = true;
                            });
                            DRB.Logic.PredefinedQuery.AfterTableLoaded(table);
                            DRB.UI.HideLoading();
                        })
                        .fail(function (xhr) {
                            DRB.UI.ShowError("DRB.Common.RetrievePersonalViews Error", DRB.Common.GetErrorMessage(xhr));
                        });
                }, DRB.Settings.TimeoutDelay);
            } else {
                DRB.Logic.PredefinedQuery.AfterTableLoaded(table);
...
DRB.Logic.PredefinedQuery.BindQueryType = function (id) {
    $("#" + id).on("change", function (e) {
        ...
        switch (queryTypeValue) {
            case "savedquery":
                $("#" + DRB.DOM.SystemViewId.Div.Id).show();
                break;
            case "userquery":
                $("#" + DRB.DOM.PersonalViewId.Div.Id).show();
                break;
            case "fetchxml":
                $("#" + DRB.DOM.FetchXML.Div.Id).show();
                break;
        }
    });
};
...
DRB.Logic.PredefinedQuery.BindPersonalView = function (id) {
    $("#" + id).on("change", function (e) {
        ...
        $("#" + DRB.DOM.PersonalViewId.Input.Id)
            .val(personalViewValue)
            .trigger("input")
            .change();
    });
};
...
DRB.Logic.PredefinedQuery.Start = function () {
    ...
    if (DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.configuration.systemViewId)) {
        $("#" + DRB.DOM.SystemViewId.Input.Id)
            .val(DRB.Metadata.CurrentNode.data.configuration.systemViewId)
            .trigger("input");
    }
    ...
    if (DRB.Utilities.HasValue(DRB.Metadata.CurrentNode.data.configuration.personalViewId)) {
        $("#" + DRB.DOM.PersonalViewId.Input.Id)
            .val(DRB.Metadata.CurrentNode.data.configuration.personalViewId)
            .trigger("input");
    }
    ...
    setTimeout(function () {
        DRB.Common.RetrieveCustomAPIs()
            .done(function (data) {
                ...
                customAPIs.forEach(function (customAPI) {
                    customAPITableLogicalNames.push(customAPI.LogicalName);
                });
                ...
                customAPITableLogicalNames.forEach(function (tableLogicalName) {
                    var table = DRB.Utilities.GetRecordById(DRB.Metadata.Tables, tableLogicalName);
                    if (DRB.Utilities.HasValue(table)) {
                        DRB.Metadata.DataverseCustomAPITables.push(
                            new DRB.Models.DataverseTable(table.LogicalName, table.Name, table.SchemaName, table.EntitySetName, table.PrimaryIdAttribute, table.PrimaryNameAttribute, table.ObjectTypeCode),
                        );
                    }
                });
                ...
                DRB.Metadata.DataverseCustomAPITables.forEach(function (customAPITable) {
                    customAPIs.forEach(function (customAPI) {
                        if (customAPI.LogicalName === customAPITable.LogicalName) {
                            customAPITable.DataverseExecutes.push(customAPI);
                        }
                    });
                });
            ...
            .fail(function (xhr) {
                DRB.UI.ShowError("DRB.Common.RetrieveCustomAPIs Error", DRB.Common.GetErrorMessage(xhr));
            });
    }, DRB.Settings.TimeoutDelay);
};
    ...
    setTimeout(function () {
        DRB.Common.RetrieveCustomActions()
            .done(function (data) {
                ...
                customActions.forEach(function (customAction) {
                    customActionTableLogicalNames.push(customAction.LogicalName);
                });
                ...
                customActionTableLogicalNames.forEach(function (tableLogicalName) {
                    var table = DRB.Utilities.GetRecordById(DRB.Metadata.Tables, tableLogicalName);
                    if (DRB.Utilities.HasValue(table)) {
                        DRB.Metadata.DataverseCustomActionTables.push(
                            new DRB.Models.DataverseTable(table.LogicalName, table.Name, table.SchemaName, table.EntitySetName, table.PrimaryIdAttribute, table.PrimaryNameAttribute, table.ObjectTypeCode),
                        );
                    }
                });
                ...
                DRB.Metadata.DataverseCustomActionTables.forEach(function (customActionTable) {
                    customActions.forEach(function (customAction) {
                        if (customAction.LogicalName === customActionTable.LogicalName) {
                            customActionTable.DataverseExecutes.push(customAction);
                        }
                    });
                });
            ...
            .fail(function (xhr) {
                DRB.UI.ShowError("DRB.Common.RetrieveCustomActions Error", DRB.Common.GetErrorMessage(xhr));
            });
    }, DRB.Settings.TimeoutDelay);
};
        ...
        DRB.Common.RetrieveMetadata()
            .done(function (data) {
                ...
                xmlEnumTypes.forEach(function (xmlEnumType) {
                    ...
                    if (!DRB.Utilities.HasValue(isFlags)) {
                        isFlags = false;
                    } else {
                        isFlags = true;
                    }
                ...
                xmlActions.forEach(function (xmlAction) {
                    ...
                    var isBound = false;
                    if (DRB.Utilities.HasValue($(xmlAction).attr("IsBound"))) {
                        isBound = true;
                    }
                    var logicalName = "none";
                    var isCollectionBound = false;
                    ...
                    xmlParameters.forEach(function (xmlParameter, xmlParameterIndex) {
                        ...
                        if (DRB.Utilities.HasValue($(xmlParameter).attr("Nullable"))) {
                ...
                dvActions.forEach(function (dvAction) {
                    actionTableLogicalNames.push(dvAction.LogicalName);
                });
                ...
                actionTableLogicalNames.forEach(function (tableLogicalName) {
                    var table = DRB.Utilities.GetRecordById(DRB.Metadata.Tables, tableLogicalName);
                    if (DRB.Utilities.HasValue(table)) {
                        DRB.Metadata.DataverseActionTables.push(
                            new DRB.Models.DataverseTable(table.LogicalName, table.Name, table.SchemaName, table.EntitySetName, table.PrimaryIdAttribute, table.PrimaryNameAttribute, table.ObjectTypeCode),
                        );
                    }
                });
                ...
                DRB.Metadata.DataverseActionTables.forEach(function (dvActionTable) {
                    dvActions.forEach(function (dvAction) {
                        if (dvAction.LogicalName === dvActionTable.LogicalName) {
                            dvActionTable.DataverseExecutes.push(dvAction);
                        }
                    });
                });
                // #endregion
                ...
                xmlFunctions.forEach(function (xmlFunction) {
                    ...
                    if (xmlReturnTypes.length === 1) {
                        ...
                        if (returnType !== "Edm.Boolean") {
                            ...
                            var isBound = false;
                            if (DRB.Utilities.HasValue($(xmlFunction).attr("IsBound"))) {
                                isBound = true;
                            }
                            var logicalName = "none";
                            var isCollectionBound = false;
                ...
                dvFunctions.forEach(function (dataverseFunction) {
                    functionTableLogicalNames.push(dataverseFunction.LogicalName);
                });
                ...
                functionTableLogicalNames.forEach(function (tableLogicalName) {
                    var table = DRB.Utilities.GetRecordById(DRB.Metadata.Tables, tableLogicalName);
                    if (DRB.Utilities.HasValue(table)) {
                        DRB.Metadata.DataverseFunctionTables.push(
                            new DRB.Models.DataverseTable(table.LogicalName, table.Name, table.SchemaName, table.EntitySetName, table.PrimaryIdAttribute, table.PrimaryNameAttribute, table.ObjectTypeCode),
                        );
                    }
                });
                ...
                DRB.Metadata.DataverseFunctionTables.forEach(function (dvFunctionTable) {
                    dvFunctions.forEach(function (dvFunction) {
                        if (dvFunction.LogicalName === dvFunctionTable.LogicalName) {
                            dvFunctionTable.DataverseExecutes.push(dvFunction);
                        }
                    });
                });
                // #endregion
    ...
    $("#" + id).on("change", function (e) {
        ...
        if (DRB.Utilities.HasValue(table)) {
            ...
            if (table.DataverseExecutes.length === 0) {
                ...
                $("#" + DRB.DOM.DataverseExecute.Dropdown.Id)
                    .val(dvExecute)
                    .change();
            }
...
DRB.Logic.DataverseExecute.BindParameterValue = function (id) {
    $("#" + id).on("change", function (e) {
        ...
        if (controlName.indexOf("cbx3_") === 0) {
            if (!DRB.Utilities.HasValue(parameterValue)) {
                parameterValue = {};
            }
        ...
        if (controlName.indexOf("cbx2_") === 0) {
            ...
            var checkTable = DRB.Utilities.GetRecordById(DRB.Metadata.Tables, controlValue);
            if (DRB.Utilities.HasValue(checkTable)) {
                primaryIdAttribute = checkTable.PrimaryIdAttribute;
            }
            ...
            if (DRB.Metadata.CurrentNode.data.configuration.dataverseParameters[elementIndex].type === "mscrm.crmbaseentity") {
                if (DRB.Utilities.HasValue(controlValue)) {
                    ...
                    $("#" + DRB.DOM.DataverseParameters.DivValue.Id + elementIndex).append(
                        DRB.UI.CreateLookup(currentIdLookup, DRB.UI.OpenLookup, {
                            openBaseEntity: true,
...
DRB.Logic.DataverseExecute.BindParameterCollectionValue = function (id) {
    $("#" + id).on("change", function (e) {
        ...
        if (collectionIndex === -1) {
            return;
        } // if collection index not found do nothing
        ...
        if (controlName.indexOf("txt_") === 0) {
            currentValue[collectionIndex] = controlValue;
        }
        // Boolan
        if (controlName.indexOf("cbx1_") === 0) {
            if (controlValue === "yes") {
                currentValue[collectionIndex] = true;
            } else {
                currentValue[collectionIndex] = false;
            }
        }
        // mscrm.baseentity (id)
        if (controlName.indexOf("txt2_") === 0) {
            currentValue[collectionIndex].id = controlValue;
        }
        ...
        if (controlName.indexOf("cbx2_") === 0) {
            ...
            if (DRB.Metadata.CurrentNode.data.configuration.dataverseParameters[index].type === "Collection(mscrm.crmbaseentity)") {
                if (DRB.Utilities.HasValue(controlValue)) {
                    ...
                    $("#" + currentIdLookup).remove();
                    $("#" + DRB.DOM.DataverseParameters.DivCollectionControlValue.Id + collectionIndex + "_" + index).append(
                        DRB.UI.CreateLookup(currentIdLookup, DRB.UI.OpenLookup, {
                            openBaseEntity: true,
                            defaultEntityType: controlValue,
                            textId: currentIdText,
...
DRB.Logic.DataverseExecute.RefreshCollectionArrows = function () {
    DRB.Metadata.CurrentNode.data.configuration.dataverseParameters.forEach(function (parameter, parameterIndex) {
        if (!Array.isArray(parameter.value)) {
            return;
        } // refresh the arrows only if the value is an array
        if (parameter.value.length === 0) {
            return;
...
DRB.Logic.DataverseExecute.MoveCollectionItem = function (direction, index, collectionIndex, parameterType) {
    ...
    if (currentParameter.value.length === 0) {
        return;
    }
    ...
    switch (parameterType) {
        ...
        case "Collection(Edm.Double)":
            ...
            $("#" + "txt_" + DRB.DOM.DataverseParameters.ControlValue.Id + collectionIndex + "_" + index)
                .val(swapItem)
                .change()
                .trigger("input");
            $("#" + "txt_" + DRB.DOM.DataverseParameters.ControlValue.Id + (collectionIndex + diff) + "_" + index)
                .val(currentItem)
                .change()
                .trigger("input");
            break;
        case "Collection(Edm.Boolean)":
            ...
            $("#" + "cbx1_" + DRB.DOM.DataverseParameters.ControlValue.Id + collectionIndex + "_" + index)
                .val(newSwapValue)
                .change();
            $("#" + "cbx1_" + DRB.DOM.DataverseParameters.ControlValue.Id + (collectionIndex + diff) + "_" + index)
                .val(newCurrentValue)
                .change();
            break;
        case "Collection(mscrm.crmbaseentity)":
            ...
            $("#" + "txt2_" + DRB.DOM.DataverseParameters.ControlValue.Id + collectionIndex + "_" + index)
                .val(swapId)
                .change()
                .trigger("input");
            $("#" + "txt2_" + DRB.DOM.DataverseParameters.ControlValue.Id + (collectionIndex + diff) + "_" + index)
                .val(currentId)
                .change()
                .trigger("input");

            $("#" + "cbx2_" + DRB.DOM.DataverseParameters.ControlValue.Id + collectionIndex + "_" + index)
                .val(swapEntityType)
                .change();
            $("#" + "cbx2_" + DRB.DOM.DataverseParameters.ControlValue.Id + (collectionIndex + diff) + "_" + index)
                .val(currentEntityType)
                .change();
            break;
    }
};
    ...
    for (var i = collectionIndex; i < lastCollectionIndex; i++) {
        switch (parameterType) {
            case "Collection(mscrm.crmbaseentity)":
                ...
                $("#" + "txt2_" + DRB.DOM.DataverseParameters.ControlValue.Id + i + "_" + index)
                    .val(nextValueId)
                    .change();
                var nextValueEntityType = $("#" + "cbx2_" + DRB.DOM.DataverseParameters.ControlValue.Id + (i + 1) + "_" + index).val();
                $("#" + "cbx2_" + DRB.DOM.DataverseParameters.ControlValue.Id + i + "_" + index)
                    .val(nextValueEntityType)
                    .change();
                break;

            case "Collection(Edm.Boolean)":
                var nextValue = $("#" + "cbx1_" + DRB.DOM.DataverseParameters.ControlValue.Id + (i + 1) + "_" + index).val();
                $("#" + "cbx1_" + DRB.DOM.DataverseParameters.ControlValue.Id + i + "_" + index)
                    .val(nextValue)
                    .change();
                break;
            ...
            case "Collection(Edm.Double)":
                ...
                $("#" + "txt_" + DRB.DOM.DataverseParameters.ControlValue.Id + i + "_" + index)
                    .val(nextValue)
                    .change();
                break;
        }
...
DRB.Logic.DataverseExecute.AddCollectionValue = function (index, parameterType) {
    ...
    $("#" + currentCollectionControlDiv).append(
        DRB.UI.CreateDownButton(DRB.DOM.ArrowDown.Id + collectionIndex + "_" + index, DRB.Logic.DataverseExecute.MoveCollectionItem, "down", index, collectionIndex, parameterType),
    );
...
DRB.Logic.DataverseExecute.AfterExecuteLoaded = function (dvExecute) {
    ...
    var operationType = 0;
    if (dvExecute.Type === "Function") {
        operationType = 1;
    }
    if (dvExecute.Type === "CustomAPI" && dvExecute.IsFunction === true) {
        operationType = 1;
    }
    ...
    if (dvExecute.Parameters.length > 0) {
        ...
        for (var index = 0; index < dvExecute.Parameters.length; index++) {
            ...
            if (index % 2 !== 0) {
                $("#" + DRB.DOM.DataverseParameters.Tr.Id + index).prop("style", "background: #f0f7ff;");
            }
            ...
            if (matchParameters === true) {
                parameterInclude = parameters[index].include;
            }
            ...
            if (parameter.Optional !== true) {
                $("#" + DRB.DOM.DataverseParameters.CheckboxInclude.Id + index).prop("disabled", "true");
            }
                ...
                if (DRB.Metadata.CurrentNode.data.configuration.primaryEntity.logicalName !== "none" && index === 0 && parameter.Name === "entityset") {
                    ...
                    if (parameter.Type.indexOf("Collection(mscrm.") === 0 && parameter.Type !== "Collection(mscrm.crmbaseentity)") {
                        ...
                        if (DRB.Utilities.HasValue(checkTable)) {
                            ...
                            divValue.append(
                                DRB.UI.CreateButton(
                                    DRB.DOM.DataverseParameters.AddButton.Id,
                                    DRB.DOM.DataverseParameters.AddButton.Name,
                                    DRB.DOM.DataverseParameters.AddButton.Class,
                                    DRB.Logic.DataverseExecute.AddCollectionValue,
                                    index,
                                    parameter.Type,
                                ),
                            );
                                ...
                                newParameterValue.forEach(function (v, vIndex) {
                                    ...
                                    switch (parameter.Type) {
                                        case "Collection(Edm.Boolean)":
                                            ...
                                            $("#" + "cbx1_" + DRB.DOM.DataverseParameters.ControlValue.Id + vIndex + "_" + index)
                                                .val(dropdownValue)
                                                .change();
                                            break;
                                        case "Collection(mscrm.crmbaseentity)":
                                            ...
                                            break;
                                        default:
                                            $("#" + "txt_" + DRB.DOM.DataverseParameters.ControlValue.Id + vIndex + "_" + index)
                                                .val(v)
                                                .change()
                                                .trigger("input");
                                            break;
            ...
            if (typeFound === false && parameter.Type === "mscrm.crmbaseentity") {
                ...
                if (matchParameters === true && DRB.Utilities.HasValue(parameterValue) && DRB.Utilities.HasValue(parameterValue.id)) {
                    $("#" + currentIdText)
                        .val(parameterValue.id)
                        .change()
                        .trigger("input");
                }
                ...
                DRB.Metadata.Tables.forEach(function (table) {
                    allEntityTypes.push(table.LogicalName);
                });

                DRB.Logic.DataverseExecute.BindParameterValue(currentIdDropdown);
                if (matchParameters === true && DRB.Utilities.HasValue(parameterValue) && DRB.Utilities.HasValue(parameterValue.entityType)) {
                    $("#" + currentIdDropdown)
                        .val(parameterValue.entityType)
                        .change();
                } else {
                    $("#" + currentIdDropdown)
                        .val("null")
                    ...
                    if (DRB.Utilities.HasValue(checkComplexType)) {
                        ...
                        if (DRB.Utilities.HasValue(checkEnumType)) {
                            ...
                            if (matchParameters === true && DRB.Utilities.HasValue(parameterValue)) {
                                ...
                                if (DRB.Utilities.HasValue(parameterValue.memberValue)) {
                                    foundMemberValue = parameterValue.memberValue;
                                }
                                if (DRB.Utilities.HasValue(parameterValue.members)) {
                                    foundMemberValue = [];
                                    if (Array.isArray(parameterValue.members)) {
                                        parameterValue.members.forEach(function (member) {
                                            foundMemberValue.push(member.value);
                                        });
                                    }
                                }
                                $("#" + currentId)
                                    .val(foundMemberValue)
                                    .change();
                            }
                        }
                    }
                    ...
                    case "Edm.Boolean":
                        ...
                        if (matchParameters === true && DRB.Utilities.HasValue(parameterValue)) {
                            ...
                            if (parameterValue === true) {
                                booleanDropdownValue = "yes";
                            }
                            $("#" + currentId)
                                .val(booleanDropdownValue)
                                .change();
                        }
                        break;
...
DRB.Logic.DataverseExecute.Start = function (requestType) {
    if (requestType === "executecustomapi") {
        ...
        if (DRB.Metadata.DataverseCustomAPIsLoaded !== true) {
            DRB.Logic.DataverseExecute.DownloadDataverseCustomAPIs(requestType);
            return;
        }
    }
    ...
    if (requestType === "executecustomaction") {
        ...
        if (DRB.Metadata.DataverseCustomActionsLoaded !== true) {
            DRB.Logic.DataverseExecute.DownloadDataverseCustomActions(requestType);
            return;
        }
    }
    ...
    if (requestType === "executeaction" || requestType === "executefunction") {
        ...
        if (DRB.Metadata.DataverseMetadataLoaded !== true) {
            DRB.Logic.DataverseExecute.DownloadDataverseMetadata(requestType);
            return;
        }
    }
...
DRB.Collection.New = function () {
    ...
    var currentNodes = $("#" + DRB.DOM.TreeView.Id)
        .jstree(true)
        .get_json("#");
    ...
    // else ask user if wants to discard current collection before proceeding
        ...
        DRB.UI.ShowQuestion("New Collection", "Are you sure to create a new Collection?<br/>The existing one will be discarded", null, function () {
            DRB.Collection.CreateDefault();
        });
    }
};
...
DRB.Collection.Load = function () {
    ...
    if (currentNodes.length === 0) {
        $("#" + DRB.DOM.Collection.LoadInput.Id).trigger("click");
    }
    // else ask user if wants to discard current collection before proceeding
    else {
        DRB.UI.ShowQuestion("Load Collection", "Are you sure to load a Collection?<br/>The existing one will be discarded", null, function () {
            $("#" + DRB.DOM.Collection.LoadInput.Id).trigger("click");
        });
    }
};
...
DRB.Collection.ExportNodes = function (currentNode, exportNode) {
    ...
    if (currentNode.type === "request") {
        exportNode.properties = currentNode.data;
    }
...
DRB.Collection.ExportNodesPostman = function (currentNode, exportNode) {
    ...
    if (currentNode.type === "collection" || currentNode.type === "folder") {
        exportNode.item = [];
    }
    if (currentNode.type === "folder" || currentNode.type === "request") {
        exportNode.name = currentNode.text;
    }
    if (currentNode.type === "request") {
    ...
    $("#" + id).on("change", function (e) {
        ...
        switch (grantType) {
            ...
            case "client_credentials":
                ...
                $("#" + postmanDOM.EndpointDropdown.Id)
                    .val(DRB.Settings.PostmanEndpoint[1].Id)
                    .change();
                break;
        }
    });
...
DRB.Collection.ExportPostman = function () {
    ...
    // if no nodes then show error
    if (currentNodes.length === 0) {
        DRB.UI.ShowError("Export Postman Collection", "Create or Load a Collection before Export");
    } else {
        var postmanDOM = DRB.DOM.Collection.Postman;
        ...
        $("#" + postmanDOM.GrantTypeDropdown.Id)
            .val(DRB.Settings.PostmanGrantType[0].Id)
            .change();
    }
};
...
DRB.SetDefaultSettings = function () {
    ...
    var requests = [
        { Id: "retrievesingle", Name: "Retrieve Single" },
    ...
    requests.forEach(function (request) {
        DRB.Settings.RequestTypes.push(new DRB.Models.IdValue(request.Id, request.Name));
    });
    // #endregion
    ...
    for (var versionCount = 0; versionCount < versions.length; versionCount++) {
        ...
        if (!DRB.Utilities.HasValue(currentVersion) || currentVersion === versions[versionCount]) {
            break;
        }
    }
    // #endregion
    ...
    DRB.Settings.OptionsOperatorOwner = [
        ...
        optEqCurrentUser,
        optNeCurrentUser,
        optEqCurrentUserHierarchy,
        optEqCurrentUserHierarchyAndTeams,
        optEqCurrentUserTeams,
...
DRB.DefineOperations = function () {
    ...
    var btn_ExportPostmanCollection = DRB.UI.CreateButton(
        DRB.DOM.Collection.ExportPostmanButton.Id,
        DRB.DOM.Collection.ExportPostmanButton.Name,
        DRB.DOM.Collection.ExportPostmanButton.Class,
        DRB.Collection.ExportPostman,
    );
                ...
                var customItems = {
                    ...
                    remove: {
                        ...
                        action: function (data) {
                            ...
                            DRB.UI.ShowQuestion(questionTitle, questionText, null, function () {
                                var inst = $.jstree.reference(data.reference);
                                var obj = inst.get_node(data.reference);
